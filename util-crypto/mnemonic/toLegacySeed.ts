...
import { bip39ToSeed, isReady } from 'https://deno.land/x/polkadot@0.2.15/wasm-crypto/mod.ts';
 ...
 *
 * ```javascript
 * import { mnemonicGenerate, mnemonicToLegacySeed, mnemonicValidate } from 'https://deno.land/x/polkadot@0.2.15/util-crypto/mod.ts';
 *
