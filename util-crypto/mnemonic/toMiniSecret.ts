...
import { stringToU8a } from 'https://deno.land/x/polkadot@0.0.0-8/util/mod.ts';
import { bip39ToMiniSecret, isReady } from 'https://deno.land/x/polkadot@0.0.0-8/wasm-crypto/mod.ts';
