...
import { stringToU8a } from 'https://deno.land/x/polkadot@0.2.18/util/mod.ts';
import { bip39ToMiniSecret, isReady } from 'https://deno.land/x/polkadot@0.2.18/wasm-crypto/mod.ts';
