...
import { bip39Generate, isReady } from 'https://deno.land/x/polkadot@0.2.40/wasm-crypto/mod.ts';
 ...
 *
 * ```javascript
 * import { mnemonicGenerate } from 'https://deno.land/x/polkadot@0.2.40/util-crypto/mod.ts';
 *
