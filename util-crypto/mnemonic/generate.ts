...
import { bip39Generate, isReady } from 'https://deno.land/x/polkadot@0.0.3/wasm-crypto/mod.ts';
 ...
 *
 * ```javascript
 * import { mnemonicGenerate } from 'https://deno.land/x/polkadot@0.0.3/util-crypto/mod.ts';
 *
