...
import { bip39Generate, isReady } from 'https://deno.land/x/polkadot@0.2.35/wasm-crypto/mod.ts';
 ...
 *
 * ```javascript
 * import { mnemonicGenerate } from 'https://deno.land/x/polkadot@0.2.35/util-crypto/mod.ts';
 *
