...
import { bip39Generate, isReady } from 'https://deno.land/x/polkadot@0.2.33/wasm-crypto/mod.ts';
 ...
 *
 * ```javascript
 * import { mnemonicGenerate } from 'https://deno.land/x/polkadot@0.2.33/util-crypto/mod.ts';
 *
