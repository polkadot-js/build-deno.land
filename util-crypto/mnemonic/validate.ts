...
import { bip39Validate, isReady } from 'https://deno.land/x/polkadot@0.2.15/wasm-crypto/mod.ts';
 ...
 *
 * ```javascript
 * import { mnemonicGenerate, mnemonicValidate } from 'https://deno.land/x/polkadot@0.2.15/util-crypto/mod.ts';
 *
