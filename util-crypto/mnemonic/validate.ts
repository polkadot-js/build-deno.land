...
import { bip39Validate, isReady } from 'https://deno.land/x/polkadot@0.2.32/wasm-crypto/mod.ts';
 ...
 *
 * ```javascript
 * import { mnemonicGenerate, mnemonicValidate } from 'https://deno.land/x/polkadot@0.2.32/util-crypto/mod.ts';
 *
