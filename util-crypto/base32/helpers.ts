...
import type { U8aLike } from 'https://deno.land/x/polkadot@0.2.37/util/types.ts';

import { u8aToU8a } from 'https://deno.land/x/polkadot@0.2.37/util/mod.ts';

export type { U8aLike } from 'https://deno.land/x/polkadot@0.2.37/util/types.ts';
