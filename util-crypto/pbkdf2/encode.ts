...
import { pbkdf2 as pbkdf2Js } from 'https://esm.sh/@noble/hashes@1.3.0/pbkdf2.js';
...
import { isReady, pbkdf2 } from 'https://deno.land/x/polkadot@0.2.35/wasm-crypto/mod.ts';
