...
import { hmac } from 'https://esm.sh/@noble/hashes@1.2.0/hmac.js';
import { sha256 } from 'https://esm.sh/@noble/hashes@1.2.0/sha256.js';
...
import { hmacSha256, hmacSha512, isReady } from 'https://deno.land/x/polkadot@0.2.31/wasm-crypto/mod.ts';
