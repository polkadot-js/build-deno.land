...
import { hmac } from 'https://esm.sh/@noble/hashes@1.3.0/hmac.js';
...
import { hmacSha256, hmacSha512, isReady } from 'https://deno.land/x/polkadot@0.2.39/wasm-crypto/mod.ts';
