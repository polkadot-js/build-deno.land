...
import { keccak_256 as keccak256Js, keccak_512 as keccak512Js } from 'https://esm.sh/@noble/hashes@1.2.0/sha3.js';

import { keccak256, keccak512 } from 'https://deno.land/x/polkadot@0.2.31/wasm-crypto/mod.ts';
 ...
 *
 * ```javascript
 * import { keccakAsU8a } from 'https://deno.land/x/polkadot@0.2.31/util-crypto/mod.ts';
 *
