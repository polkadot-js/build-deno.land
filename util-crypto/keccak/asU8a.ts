...
import { keccak_256 as keccak256Js, keccak_512 as keccak512Js } from 'https://esm.sh/@noble/hashes@1.1.5/sha3.js';

import { keccak256, keccak512 } from 'https://deno.land/x/polkadot@0.2.26/wasm-crypto/mod.ts';
 ...
 *
 * ```javascript
 * import { keccakAsU8a } from 'https://deno.land/x/polkadot@0.2.26/util-crypto/mod.ts';
 *
