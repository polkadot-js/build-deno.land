...
import { scrypt as scryptJs } from 'https://esm.sh/@noble/hashes@1.1.5/scrypt.js';

import { hasBigInt, objectSpread, u8aToU8a } from 'https://deno.land/x/polkadot@0.2.24/util/mod.ts';
import { isReady, scrypt } from 'https://deno.land/x/polkadot@0.2.24/wasm-crypto/mod.ts';
