...
import { scrypt as scryptJs } from 'https://esm.sh/@noble/hashes@1.2.0/scrypt.js';

import { hasBigInt, objectSpread, u8aToU8a } from 'https://deno.land/x/polkadot@0.2.28/util/mod.ts';
import { isReady, scrypt } from 'https://deno.land/x/polkadot@0.2.28/wasm-crypto/mod.ts';
