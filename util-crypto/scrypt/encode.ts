...
import { scrypt as scryptJs } from 'https://esm.sh/@noble/hashes@1.1.3/scrypt.js';

import { hasBigInt, objectSpread, u8aToU8a } from 'https://deno.land/x/polkadot@0.2.15/util/mod.ts';
import { isReady, scrypt } from 'https://deno.land/x/polkadot@0.2.15/wasm-crypto/mod.ts';
