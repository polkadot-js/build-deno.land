...
import { getPublicKey } from 'https://esm.sh/@noble/secp256k1@1.6.3';

import { hasBigInt, u8aEmpty } from 'https://deno.land/x/polkadot@0.2.6/util/mod.ts';
import { isReady, secp256k1FromSeed } from 'https://deno.land/x/polkadot@0.2.6/wasm-crypto/mod.ts';
