...
import { ed25519Verify as wasmVerify, isReady } from 'https://deno.land/x/polkadot@0.2.38/wasm-crypto/mod.ts';
 ...
 *
 * ```javascript
 * import { ed25519Verify } from 'https://deno.land/x/polkadot@0.2.38/util-crypto/mod.ts';
 *
