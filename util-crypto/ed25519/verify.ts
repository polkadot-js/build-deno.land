...
import { assert, u8aToU8a } from 'https://deno.land/x/polkadot@0.0.0-5/util/mod.ts';
import { ed25519Verify as wasmVerify, isReady } from 'https://deno.land/x/polkadot@0.0.0-5/wasm-crypto/mod.ts';
 ...
 *
 * ```javascript
 * import { ed25519Verify } from 'https://deno.land/x/polkadot@0.0.0-5/util-crypto/mod.ts';
 *
