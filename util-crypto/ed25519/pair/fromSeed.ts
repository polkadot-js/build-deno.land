...
import { hasBigInt, u8aConcatStrict } from 'https://deno.land/x/polkadot@0.2.41/util/mod.ts';
import { ed25519KeypairFromSeed, isReady } from 'https://deno.land/x/polkadot@0.2.41/wasm-crypto/mod.ts';
