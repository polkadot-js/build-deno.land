...
import { hasBigInt, u8aToU8a } from 'https://deno.land/x/polkadot@0.2.40/util/mod.ts';
import { ed25519Sign as wasmSign, isReady } from 'https://deno.land/x/polkadot@0.2.40/wasm-crypto/mod.ts';
 ...
 *
 * ```javascript
 * import { ed25519Sign } from 'https://deno.land/x/polkadot@0.2.40/util-crypto/mod.ts';
 *
 * ed25519Sign([...], [...]); // => [...]
 * ```
 */
