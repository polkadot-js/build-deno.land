...
import { ed25519Sign as wasmSign, isReady } from 'https://deno.land/x/polkadot@0.2.27/wasm-crypto/mod.ts';
 ...
 *
 * ```javascript
 * import { ed25519Sign } from 'https://deno.land/x/polkadot@0.2.27/util-crypto/mod.ts';
 *
 * ed25519Sign([...], [...]); // => [...]
 * ```
 */
