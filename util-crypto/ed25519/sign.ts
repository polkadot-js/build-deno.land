...
import { u8aToU8a } from 'https://deno.land/x/polkadot@0.2.19/util/mod.ts';
import { ed25519Sign as wasmSign, isReady } from 'https://deno.land/x/polkadot@0.2.19/wasm-crypto/mod.ts';
 ...
 *
 * ```javascript
 * import { ed25519Sign } from 'https://deno.land/x/polkadot@0.2.19/util-crypto/mod.ts';
 *
 * ed25519Sign([...], [...]); // => [...]
 * ```
 */
