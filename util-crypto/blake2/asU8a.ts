...
import { blake2b as blake2bJs } from 'https://esm.sh/@noble/hashes@1.1.5/blake2b.js';

import { hasBigInt, u8aToU8a } from 'https://deno.land/x/polkadot@0.2.24/util/mod.ts';
import { blake2b, isReady } from 'https://deno.land/x/polkadot@0.2.24/wasm-crypto/mod.ts';
