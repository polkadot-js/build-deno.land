...
import { blake2b as blake2bJs } from 'https://esm.sh/@noble/hashes@1.2.0/blake2b.js';

import { hasBigInt, u8aToU8a } from 'https://deno.land/x/polkadot@0.2.28/util/mod.ts';
import { blake2b, isReady } from 'https://deno.land/x/polkadot@0.2.28/wasm-crypto/mod.ts';
