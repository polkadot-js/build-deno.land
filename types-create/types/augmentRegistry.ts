...
import type { Codec, CodecClass, ICompact, INumber } from 'https://deno.land/x/polkadot@0.0.4-8/types-codec/types/index.ts';
import type { ILookup, TypeDef } from 'https://deno.land/x/polkadot@0.0.4-8/types-create/types/index.ts';

declare module 'https://deno.land/x/polkadot@0.0.4-8/types-codec/types/registry.ts' {
  interface Registry {
