...
import type { Option, Text } from 'https://deno.land/x/polkadot@0.2.39/types-codec/mod.ts';
import type { ICompact, INumber, LookupString } from 'https://deno.land/x/polkadot@0.2.39/types-codec/types/index.ts';
