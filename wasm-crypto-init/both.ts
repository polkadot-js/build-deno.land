...
import { createWasmFn } from 'https://deno.land/x/polkadot@0.2.37/wasm-bridge/mod.ts';
import { asmJsInit } from 'https://deno.land/x/polkadot@0.2.37/wasm-crypto-asmjs/mod.ts';
import { wasmBytes } from 'https://deno.land/x/polkadot@0.2.37/wasm-crypto-wasm/mod.ts';
