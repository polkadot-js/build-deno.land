...
import { asmJsInit } from 'https://deno.land/x/polkadot@0.2.23/wasm-crypto-asmjs/mod.ts';
import { wasmBytes } from 'https://deno.land/x/polkadot@0.2.23/wasm-crypto-wasm/mod.ts';
