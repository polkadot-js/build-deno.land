...
import type { ApiRx } from 'https://deno.land/x/polkadot@0.2.36/api/mod.ts';
import type { AccountId, Hash } from 'https://deno.land/x/polkadot@0.2.36/types/interfaces/index.ts';
import type { Abi } from '../Abi/index.ts';

import { toRxMethod } from 'https://deno.land/x/polkadot@0.2.36/api/mod.ts';
