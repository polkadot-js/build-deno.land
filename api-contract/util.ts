...
import type { EventRecord } from 'https://deno.land/x/polkadot@0.0.4-2/types/interfaces/index.ts';
...
import { isBigInt, isBn, isNumber, isString } from 'https://deno.land/x/polkadot@0.0.4-2/util/mod.ts';
