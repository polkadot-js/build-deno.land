...
import type { EventRecord } from 'https://deno.land/x/polkadot@0.0.4-4/types/interfaces/index.ts';
...
import { isBigInt, isBn, isNumber, isString } from 'https://deno.land/x/polkadot@0.0.4-4/util/mod.ts';
