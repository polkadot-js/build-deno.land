...
import type { SubmittableResult } from 'https://deno.land/x/polkadot@0.0.2/api/mod.ts';
import type { EventRecord } from 'https://deno.land/x/polkadot@0.0.2/types/interfaces/index.ts';
...
import { isBigInt, isBn, isNumber, isString } from 'https://deno.land/x/polkadot@0.0.2/util/mod.ts';
