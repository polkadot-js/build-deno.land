...
import type { EventRecord } from 'https://deno.land/x/polkadot@0.0.5/types/interfaces/index.ts';
...
import { isBigInt, isBn, isNumber, isString } from 'https://deno.land/x/polkadot@0.0.5/util/mod.ts';
