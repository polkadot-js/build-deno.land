...
import type { EventRecord } from 'https://deno.land/x/polkadot@0.0.0-8/types/interfaces.ts';
...
import { isBigInt, isBn, isNumber, isString } from 'https://deno.land/x/polkadot@0.0.0-8/util/mod.ts';
