...
import type { AccountId, EventRecord, Hash } from 'https://deno.land/x/polkadot@0.0.4-5/types/interfaces/index.ts';
...
import { BN_ZERO, isUndefined } from 'https://deno.land/x/polkadot@0.0.4-5/util/mod.ts';
