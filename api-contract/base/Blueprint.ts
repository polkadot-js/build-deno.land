...
import type { AccountId, EventRecord, Hash } from 'https://deno.land/x/polkadot@0.0.0-7/types/interfaces.ts';
...
import { BN_ZERO, isUndefined } from 'https://deno.land/x/polkadot@0.0.0-7/util/mod.ts';
