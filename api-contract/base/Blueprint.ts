...
import type { AccountId, EventRecord, Hash } from 'https://deno.land/x/polkadot@0.1.0/types/interfaces/index.ts';
...
import { BN_ZERO, isUndefined } from 'https://deno.land/x/polkadot@0.1.0/util/mod.ts';
