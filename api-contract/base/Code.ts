...
import type { AccountId, EventRecord } from 'https://deno.land/x/polkadot@0.0.0-5/types/interfaces.ts';
...
import { assert, BN_ZERO, compactAddLength, isUndefined, isWasm, u8aToU8a } from 'https://deno.land/x/polkadot@0.0.0-5/util/mod.ts';
