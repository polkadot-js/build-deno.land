...
import type { AccountId, EventRecord } from 'https://deno.land/x/polkadot@0.2.45/types/interfaces/index.ts';
...
import { BN_ZERO, compactAddLength, isRiscV, isUndefined, isWasm, u8aToU8a } from 'https://deno.land/x/polkadot@0.2.45/util/mod.ts';
