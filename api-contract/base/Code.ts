...
import type { AccountId, EventRecord } from 'https://deno.land/x/polkadot@0.2.21/types/interfaces/index.ts';
...
import { BN_ZERO, compactAddLength, isUndefined, isWasm, u8aToU8a } from 'https://deno.land/x/polkadot@0.2.21/util/mod.ts';
