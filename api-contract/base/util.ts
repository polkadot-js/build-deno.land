...
import type { SubmittableResult } from 'https://deno.land/x/polkadot@0.0.6/api/mod.ts';
...
import { Bytes } from 'https://deno.land/x/polkadot@0.0.6/types/mod.ts';
import { compactAddLength, u8aToU8a } from 'https://deno.land/x/polkadot@0.0.6/util/mod.ts';
