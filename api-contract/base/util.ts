...
import type { SubmittableResult } from 'https://deno.land/x/polkadot@0.2.2/api/mod.ts';
...
import { Bytes } from 'https://deno.land/x/polkadot@0.2.2/types/mod.ts';
import { compactAddLength, u8aToU8a } from 'https://deno.land/x/polkadot@0.2.2/util/mod.ts';
