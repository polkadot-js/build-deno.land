...
import type { WeightV1, WeightV2 } from 'https://deno.land/x/polkadot@0.2.41/types/interfaces/index.ts';
...
import { Bytes } from 'https://deno.land/x/polkadot@0.2.41/types/mod.ts';
import { bnToBn, compactAddLength, u8aToU8a } from 'https://deno.land/x/polkadot@0.2.41/util/mod.ts';
