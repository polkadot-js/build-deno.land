...
import type { SubmittableResult } from 'https://deno.land/x/polkadot@0.2.33/api/mod.ts';
...
import type { WeightV1, WeightV2 } from 'https://deno.land/x/polkadot@0.2.33/types/interfaces/index.ts';
...
import { bnToBn, compactAddLength, u8aToU8a } from 'https://deno.land/x/polkadot@0.2.33/util/mod.ts';
