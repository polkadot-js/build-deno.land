...
import type { SubmittableResult } from 'https://deno.land/x/polkadot@0.2.22/api/mod.ts';
...
import type { WeightV1, WeightV2 } from 'https://deno.land/x/polkadot@0.2.22/types/interfaces/index.ts';
...
import { Bytes } from 'https://deno.land/x/polkadot@0.2.22/types/mod.ts';
import { bnToBn, compactAddLength, u8aToU8a } from 'https://deno.land/x/polkadot@0.2.22/util/mod.ts';
