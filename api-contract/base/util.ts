...
import type { SubmittableResult } from 'https://deno.land/x/polkadot@0.1.0/api/mod.ts';
...
import { Bytes } from 'https://deno.land/x/polkadot@0.1.0/types/mod.ts';
import { compactAddLength, u8aToU8a } from 'https://deno.land/x/polkadot@0.1.0/util/mod.ts';
