...
import type { AccountId, ContractExecResult, EventRecord, Weight } from 'https://deno.land/x/polkadot@0.0.4-6/types/interfaces/index.ts';
...
import { assert, BN, BN_HUNDRED, BN_ONE, BN_ZERO, bnToBn, isFunction, isUndefined, logger } from 'https://deno.land/x/polkadot@0.0.4-6/util/mod.ts';
