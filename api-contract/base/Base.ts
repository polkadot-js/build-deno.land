...
import type { WeightV2 } from 'https://deno.land/x/polkadot@0.2.45/types/interfaces/index.ts';
import type { Registry } from 'https://deno.land/x/polkadot@0.2.45/types/types/index.ts';

import { isFunction } from 'https://deno.land/x/polkadot@0.2.45/util/mod.ts';
