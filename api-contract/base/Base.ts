...
import type { WeightV2 } from 'https://deno.land/x/polkadot@0.2.44/types/interfaces/index.ts';
import type { Registry } from 'https://deno.land/x/polkadot@0.2.44/types/types/index.ts';

import { isFunction } from 'https://deno.land/x/polkadot@0.2.44/util/mod.ts';
