...
import type { ApiBase } from 'https://deno.land/x/polkadot@0.2.16/api/base/index.ts';
...
import type { ContractExecResultResult, ContractSelector, StorageDeposit, Weight, WeightV2 } from 'https://deno.land/x/polkadot@0.2.16/types/interfaces/index.ts';
import type { Codec, TypeDef } from 'https://deno.land/x/polkadot@0.2.16/types/types/index.ts';
