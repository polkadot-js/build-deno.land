...
import type { ContractMetadataV0, ContractMetadataV1 } from 'https://deno.land/x/polkadot@0.2.20/types/interfaces/index.ts';
import type { Registry } from 'https://deno.land/x/polkadot@0.2.20/types/types/index.ts';

import { convertSiV0toV1 } from 'https://deno.land/x/polkadot@0.2.20/types/mod.ts';
