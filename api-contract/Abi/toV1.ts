...
import type { ContractMetadataV0, ContractMetadataV1 } from 'https://deno.land/x/polkadot@0.2.35/types/interfaces/index.ts';
import type { Registry } from 'https://deno.land/x/polkadot@0.2.35/types/types/index.ts';

import { convertSiV0toV1 } from 'https://deno.land/x/polkadot@0.2.35/types/mod.ts';
