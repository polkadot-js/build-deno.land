...
import type { AccountId, Hash } from 'https://deno.land/x/polkadot@0.2.34/types/interfaces/index.ts';

import { ApiPromise, toPromiseMethod } from 'https://deno.land/x/polkadot@0.2.34/api/mod.ts';
