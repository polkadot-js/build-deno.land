...
import type { AccountId, Hash } from 'https://deno.land/x/polkadot@0.0.0-7/types/interfaces.ts';

import { ApiPromise, toPromiseMethod } from 'https://deno.land/x/polkadot@0.0.0-7/api/mod.ts';
