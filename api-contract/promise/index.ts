...
import type { AccountId, Hash } from 'https://deno.land/x/polkadot@0.1.0/types/interfaces/index.ts';

import { ApiPromise, toPromiseMethod } from 'https://deno.land/x/polkadot@0.1.0/api/mod.ts';
