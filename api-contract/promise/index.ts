...
import type { AccountId, Hash } from 'https://deno.land/x/polkadot@0.0.0-8/types/interfaces.ts';

import { ApiPromise, toPromiseMethod } from 'https://deno.land/x/polkadot@0.0.0-8/api/mod.ts';
