...
import type { AccountId, Hash } from 'https://deno.land/x/polkadot@0.2.28/types/interfaces/index.ts';

import { ApiPromise, toPromiseMethod } from 'https://deno.land/x/polkadot@0.2.28/api/mod.ts';
