...
import type { AccountId, Hash } from 'https://deno.land/x/polkadot@0.2.8/types/interfaces/index.ts';

import { ApiPromise, toPromiseMethod } from 'https://deno.land/x/polkadot@0.2.8/api/mod.ts';
