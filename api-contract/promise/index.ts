...
import type { AccountId, Hash } from 'https://deno.land/x/polkadot@0.2.16/types/interfaces/index.ts';

import { ApiPromise, toPromiseMethod } from 'https://deno.land/x/polkadot@0.2.16/api/mod.ts';
