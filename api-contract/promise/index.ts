...
import type { AccountId, Hash } from 'https://deno.land/x/polkadot@0.0.4-4/types/interfaces/index.ts';

import { ApiPromise, toPromiseMethod } from 'https://deno.land/x/polkadot@0.0.4-4/api/mod.ts';
