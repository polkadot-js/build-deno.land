...
import type { AccountId, Hash } from 'https://deno.land/x/polkadot@0.0.4-3/types/interfaces/index.ts';

import { ApiPromise, toPromiseMethod } from 'https://deno.land/x/polkadot@0.0.4-3/api/mod.ts';
