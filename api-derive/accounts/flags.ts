...
import type { AccountId, Address, Balance } from 'https://deno.land/x/polkadot@0.0.4-6/types/interfaces/index.ts';
import type{ PalletElectionsPhragmenSeatHolder } from 'https://deno.land/x/polkadot@0.0.4-6/types/lookup.ts';
import type { Codec } from 'https://deno.land/x/polkadot@0.0.4-6/types/types/index.ts';
