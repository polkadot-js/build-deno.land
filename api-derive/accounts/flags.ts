...
import type { AccountId, Address, Balance } from 'https://deno.land/x/polkadot@0.0.0-8/types/interfaces.ts';
import type{ PalletElectionsPhragmenSeatHolder } from 'https://deno.land/x/polkadot@0.0.0-8/types/lookup.ts';
import type { Codec } from 'https://deno.land/x/polkadot@0.0.0-8/types/types.ts';
