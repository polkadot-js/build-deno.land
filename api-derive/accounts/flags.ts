...
import type { AccountId, Address, Balance } from 'https://deno.land/x/polkadot@0.2.39/types/interfaces/index.ts';
...
import { isFunction } from 'https://deno.land/x/polkadot@0.2.39/util/mod.ts';
