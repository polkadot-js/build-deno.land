...
import type { AccountId, Address, Balance } from 'https://deno.land/x/polkadot@0.0.0-5/types/interfaces.ts';
import type{ PalletElectionsPhragmenSeatHolder } from 'https://deno.land/x/polkadot@0.0.0-5/types/lookup.ts';
import type { Codec } from 'https://deno.land/x/polkadot@0.0.0-5/types/types.ts';
...
import { isFunction } from 'https://deno.land/x/polkadot@0.0.0-5/util/mod.ts';
