...
import type { AccountId, Address, Balance } from 'https://deno.land/x/polkadot@0.2.32/types/interfaces/index.ts';
import type{ PalletElectionsPhragmenSeatHolder } from 'https://deno.land/x/polkadot@0.2.32/types/lookup.ts';
import type { Codec } from 'https://deno.land/x/polkadot@0.2.32/types/types/index.ts';
