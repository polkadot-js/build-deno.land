...
import type { Bytes, Option, u32 } from 'https://deno.land/x/polkadot@0.0.2/types/mod.ts';
import type { AccountId, AccountIndex, Address, Balance } from 'https://deno.land/x/polkadot@0.0.2/types/interfaces/index.ts';
