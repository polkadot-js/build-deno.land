...
import type { AccountId } from 'https://deno.land/x/polkadot@0.2.11/types/interfaces/index.ts';
import type { PalletIdentityIdentityInfo, PalletIdentityRegistration } from 'https://deno.land/x/polkadot@0.2.11/types/lookup.ts';
...
import { isHex, u8aToString } from 'https://deno.land/x/polkadot@0.2.11/util/mod.ts';
