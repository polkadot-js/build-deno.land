...
import type { PalletIdentityIdentityInfo, PalletIdentityRegistration } from 'https://deno.land/x/polkadot@0.0.8/types/lookup.ts';
...
import { isHex, u8aToString } from 'https://deno.land/x/polkadot@0.0.8/util/mod.ts';
