...
import type { AccountId } from 'https://deno.land/x/polkadot@0.2.18/types/interfaces/index.ts';
import type { PalletIdentityIdentityInfo, PalletIdentityRegistration } from 'https://deno.land/x/polkadot@0.2.18/types/lookup.ts';
...
import { isHex, u8aToString } from 'https://deno.land/x/polkadot@0.2.18/util/mod.ts';
