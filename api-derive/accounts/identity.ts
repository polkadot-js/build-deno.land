...
import type { AccountId } from 'https://deno.land/x/polkadot@0.0.0-8/types/interfaces.ts';
import type { PalletIdentityIdentityInfo, PalletIdentityRegistration } from 'https://deno.land/x/polkadot@0.0.0-8/types/lookup.ts';
import type { Option } from 'https://deno.land/x/polkadot@0.0.0-8/types-codec/mod.ts';
...
import { isHex, u8aToString } from 'https://deno.land/x/polkadot@0.0.0-8/util/mod.ts';
