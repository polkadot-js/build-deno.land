...
import type { AccountId } from 'https://deno.land/x/polkadot@0.0.4/types/interfaces/index.ts';
import type { PalletIdentityIdentityInfo, PalletIdentityRegistration } from 'https://deno.land/x/polkadot@0.0.4/types/lookup.ts';
import type { Option } from 'https://deno.land/x/polkadot@0.0.4/types-codec/mod.ts';
...
import { isHex, u8aToString } from 'https://deno.land/x/polkadot@0.0.4/util/mod.ts';
