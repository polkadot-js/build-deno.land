...
import type { PalletIdentityIdentityInfo, PalletIdentityRegistration } from 'https://deno.land/x/polkadot@0.2.45/types/lookup.ts';
...
import { isHex, u8aToString } from 'https://deno.land/x/polkadot@0.2.45/util/mod.ts';
