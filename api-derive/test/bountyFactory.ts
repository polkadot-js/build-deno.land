...
import type { Bounty, BountyIndex } from 'https://deno.land/x/polkadot@0.2.39/types/interfaces/index.ts';
import type { Codec, Constructor, InterfaceTypes, Registry } from 'https://deno.land/x/polkadot@0.2.39/types/types/index.ts';

import { Option, StorageKey } from 'https://deno.land/x/polkadot@0.2.39/types/mod.ts';
