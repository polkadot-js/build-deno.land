...
import { Bounty, BountyIndex } from 'https://deno.land/x/polkadot/types/interfaces.ts';
import { Codec, Constructor, InterfaceTypes, Registry } from 'https://deno.land/x/polkadot/types/types.ts';
