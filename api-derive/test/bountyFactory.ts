...
import type { ApiPromise } from 'https://deno.land/x/polkadot@0.2.37/api/mod.ts';
import type { Bounty, BountyIndex } from 'https://deno.land/x/polkadot@0.2.37/types/interfaces/index.ts';
import type { Codec, Constructor, InterfaceTypes, Registry } from 'https://deno.land/x/polkadot@0.2.37/types/types/index.ts';

import { Option, StorageKey } from 'https://deno.land/x/polkadot@0.2.37/types/mod.ts';
