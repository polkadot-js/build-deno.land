...
import type { SubmittableExtrinsic } from 'https://deno.land/x/polkadot@0.2.36/api-base/types/index.ts';
import type { Proposal, ProposalIndex } from 'https://deno.land/x/polkadot@0.2.36/types/interfaces/index.ts';
