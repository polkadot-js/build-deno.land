...
import type { ApiPromise } from 'https://deno.land/x/polkadot@0.0.3/api/mod.ts';
import type { SubmittableExtrinsic } from 'https://deno.land/x/polkadot@0.0.3/api-base/types/index.ts';

import { Proposal, ProposalIndex } from 'https://deno.land/x/polkadot@0.0.3/types/interfaces/index.ts';
