...
import type { ApiPromise } from 'https://deno.land/x/polkadot@0.2.35/api/mod.ts';
import type { SubmittableExtrinsic } from 'https://deno.land/x/polkadot@0.2.35/api-base/types/index.ts';
import type { Proposal, ProposalIndex } from 'https://deno.land/x/polkadot@0.2.35/types/interfaces/index.ts';
