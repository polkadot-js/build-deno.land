...
import { ApiPromise, WsProvider } from 'https://deno.land/x/polkadot@0.0.9/api/mod.ts';
import { Metadata, TypeRegistry } from 'https://deno.land/x/polkadot@0.0.9/types/mod.ts';
import metaStatic from 'https://deno.land/x/polkadot@0.0.9/types-support/metadata/static-substrate.ts';
