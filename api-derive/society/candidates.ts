...
import type { BalanceOf } from 'https://deno.land/x/polkadot@0.2.11/types/interfaces/index.ts';
import type { PalletSocietyBid, PalletSocietyBidKind } from 'https://deno.land/x/polkadot@0.2.11/types/lookup.ts';
