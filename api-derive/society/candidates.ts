...
import type { BalanceOf } from 'https://deno.land/x/polkadot@0.0.0-8/types/interfaces.ts';
import type { PalletSocietyBid, PalletSocietyBidKind } from 'https://deno.land/x/polkadot@0.0.0-8/types/lookup.ts';
