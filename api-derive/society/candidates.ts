...
import type { BalanceOf } from 'https://deno.land/x/polkadot@0.2.7/types/interfaces/index.ts';
import type { PalletSocietyBid, PalletSocietyBidKind } from 'https://deno.land/x/polkadot@0.2.7/types/lookup.ts';
