...
import type { BalanceOf } from 'https://deno.land/x/polkadot@0.0.0-5/types/interfaces.ts';
import type { PalletSocietyBid, PalletSocietyBidKind } from 'https://deno.land/x/polkadot@0.0.0-5/types/lookup.ts';
