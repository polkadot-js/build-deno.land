...
import type { BalanceOf } from 'https://deno.land/x/polkadot@0.2.34/types/interfaces/index.ts';
import type { PalletSocietyBid, PalletSocietyBidKind } from 'https://deno.land/x/polkadot@0.2.34/types/lookup.ts';
