...
import type { AccountId32, BalanceOf } from 'https://deno.land/x/polkadot@0.2.45/types/interfaces/index.ts';
import type { PalletSocietyBid, PalletSocietyBidKind, PalletSocietyCandidacy } from 'https://deno.land/x/polkadot@0.2.45/types/lookup.ts';
import type { ITuple } from 'https://deno.land/x/polkadot@0.2.45/types/types/index.ts';
import type { Option, Vec } from 'https://deno.land/x/polkadot@0.2.45/types-codec/mod.ts';
