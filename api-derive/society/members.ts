...
import type { PalletSocietyVote, PalletSocietyVouchingStatus } from 'https://deno.land/x/polkadot@0.2.45/types/lookup.ts';
import type { ITuple } from 'https://deno.land/x/polkadot@0.2.45/types/types/index.ts';
import type { bool, Option, u32, u128, Vec } from 'https://deno.land/x/polkadot@0.2.45/types-codec/mod.ts';
