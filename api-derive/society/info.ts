...
import type { Option, u32, Vec } from 'https://deno.land/x/polkadot@0.0.0-6/types/mod.ts';
import type { AccountId, BalanceOf } from 'https://deno.land/x/polkadot@0.0.0-6/types/interfaces.ts';
import type { PalletSocietyBid } from 'https://deno.land/x/polkadot@0.0.0-6/types/lookup.ts';
