...
import type { QueryableModuleStorage } from 'https://deno.land/x/polkadot@0.0.4-4/api-base/types/index.ts';
import type { Vec } from 'https://deno.land/x/polkadot@0.0.4-4/types/mod.ts';
import type { AccountId, Balance } from 'https://deno.land/x/polkadot@0.0.4-4/types/interfaces/index.ts';
import type { PalletElectionsPhragmenVoter } from 'https://deno.land/x/polkadot@0.0.4-4/types/lookup.ts';
