...
import type { QueryableModuleStorage } from 'https://deno.land/x/polkadot@0.2.30/api-base/types/index.ts';
import type { Vec } from 'https://deno.land/x/polkadot@0.2.30/types/mod.ts';
import type { AccountId, Balance } from 'https://deno.land/x/polkadot@0.2.30/types/interfaces/index.ts';
import type { PalletElectionsPhragmenVoter } from 'https://deno.land/x/polkadot@0.2.30/types/lookup.ts';
