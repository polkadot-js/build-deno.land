...
import type { QueryableModuleStorage } from 'https://deno.land/x/polkadot@0.2.31/api-base/types/index.ts';
...
import type { PalletElectionsPhragmenVoter } from 'https://deno.land/x/polkadot@0.2.31/types/lookup.ts';
