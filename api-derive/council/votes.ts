...
import type { QueryableModuleStorage } from 'https://deno.land/x/polkadot@0.0.2/api-base/types/index.ts';
...
import type { PalletElectionsPhragmenVoter } from 'https://deno.land/x/polkadot@0.0.2/types/lookup.ts';
