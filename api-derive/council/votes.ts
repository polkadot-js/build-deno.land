...
import type { QueryableModuleStorage } from 'https://deno.land/x/polkadot@0.2.35/api-base/types/index.ts';
...
import type { PalletElectionsPhragmenVoter } from 'https://deno.land/x/polkadot@0.2.35/types/lookup.ts';
