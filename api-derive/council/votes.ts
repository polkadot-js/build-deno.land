...
import type { QueryableModuleStorage } from 'https://deno.land/x/polkadot@0.2.24/api-base/types/index.ts';
...
import type { PalletElectionsPhragmenVoter } from 'https://deno.land/x/polkadot@0.2.24/types/lookup.ts';
