...
import type { QueryableModuleStorage } from 'https://deno.land/x/polkadot@0.0.5/api-base/types/index.ts';
import type { Vec } from 'https://deno.land/x/polkadot@0.0.5/types/mod.ts';
import type { AccountId, Balance } from 'https://deno.land/x/polkadot@0.0.5/types/interfaces/index.ts';
import type { PalletElectionsPhragmenVoter } from 'https://deno.land/x/polkadot@0.0.5/types/lookup.ts';
