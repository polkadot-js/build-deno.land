...
import type { H256 } from 'https://deno.land/x/polkadot@0.0.0-6/types/interfaces.ts';
import type { PalletDemocracyVoteThreshold } from 'https://deno.land/x/polkadot@0.0.0-6/types/lookup.ts';
