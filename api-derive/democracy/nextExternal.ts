...
import type { H256 } from 'https://deno.land/x/polkadot@0.2.4/types/interfaces/index.ts';
import type { PalletDemocracyVoteThreshold } from 'https://deno.land/x/polkadot@0.2.4/types/lookup.ts';
