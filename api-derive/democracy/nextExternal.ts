...
import type { H256 } from 'https://deno.land/x/polkadot@0.2.32/types/interfaces/index.ts';
import type { FrameSupportPreimagesBounded, PalletDemocracyVoteThreshold } from 'https://deno.land/x/polkadot@0.2.32/types/lookup.ts';
