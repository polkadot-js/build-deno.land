...
import type { H256 } from 'https://deno.land/x/polkadot@0.1.0/types/interfaces/index.ts';
import type { PalletDemocracyVoteThreshold } from 'https://deno.land/x/polkadot@0.1.0/types/lookup.ts';
