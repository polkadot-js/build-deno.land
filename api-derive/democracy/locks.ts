...
import type { AccountId, ReferendumInfoTo239, Vote } from 'https://deno.land/x/polkadot@0.2.42/types/interfaces/index.ts';
import type { PalletDemocracyReferendumInfo, PalletDemocracyVoteVoting } from 'https://deno.land/x/polkadot@0.2.42/types/lookup.ts';
...
import { BN_ZERO, isUndefined } from 'https://deno.land/x/polkadot@0.2.42/util/mod.ts';
