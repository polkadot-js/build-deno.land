...
import type { ReferendumInfoTo239, Tally } from 'https://deno.land/x/polkadot@0.0.3/types/interfaces/index.ts';
import type { PalletDemocracyReferendumInfo, PalletDemocracyReferendumStatus, PalletDemocracyVoteThreshold } from 'https://deno.land/x/polkadot@0.0.3/types/lookup.ts';
import type { Option } from 'https://deno.land/x/polkadot@0.0.3/types-codec/mod.ts';
import type { DeriveReferendum, DeriveReferendumVote, DeriveReferendumVotes, DeriveReferendumVoteState } from '../types.ts';

import { BN, bnSqrt } from 'https://deno.land/x/polkadot@0.0.3/util/mod.ts';
