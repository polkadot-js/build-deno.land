...
import type { ReferendumInfoTo239, Tally } from 'https://deno.land/x/polkadot@0.0.0-6/types/interfaces.ts';
import type { PalletDemocracyReferendumInfo, PalletDemocracyReferendumStatus, PalletDemocracyVoteThreshold } from 'https://deno.land/x/polkadot@0.0.0-6/types/lookup.ts';
...
import { BN, bnSqrt } from 'https://deno.land/x/polkadot@0.0.0-6/util/mod.ts';
