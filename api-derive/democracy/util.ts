...
import type { ReferendumInfoTo239, Tally } from 'https://deno.land/x/polkadot@0.2.6/types/interfaces/index.ts';
import type { PalletDemocracyReferendumInfo, PalletDemocracyReferendumStatus, PalletDemocracyVoteThreshold } from 'https://deno.land/x/polkadot@0.2.6/types/lookup.ts';
...
import { BN, bnSqrt, objectSpread } from 'https://deno.land/x/polkadot@0.2.6/util/mod.ts';
