...
import type { Hash, ReferendumInfoTo239, Tally } from 'https://deno.land/x/polkadot@0.2.20/types/interfaces/index.ts';
import type { FrameSupportPreimagesBounded, PalletDemocracyReferendumInfo, PalletDemocracyReferendumStatus, PalletDemocracyVoteThreshold } from 'https://deno.land/x/polkadot@0.2.20/types/lookup.ts';
...
import { BN, bnSqrt, isHex, isString, isU8a, objectSpread, stringToHex, u8aToHex } from 'https://deno.land/x/polkadot@0.2.20/util/mod.ts';
