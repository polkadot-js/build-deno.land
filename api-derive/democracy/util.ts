...
import type { ReferendumInfoTo239, Tally } from 'https://deno.land/x/polkadot@0.0.0-8/types/interfaces.ts';
import type { PalletDemocracyReferendumInfo, PalletDemocracyReferendumStatus, PalletDemocracyVoteThreshold } from 'https://deno.land/x/polkadot@0.0.0-8/types/lookup.ts';
...
import { BN, bnSqrt } from 'https://deno.land/x/polkadot@0.0.0-8/util/mod.ts';
