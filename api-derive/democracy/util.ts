...
import type { Hash, ReferendumInfoTo239, Tally } from 'https://deno.land/x/polkadot@0.2.16/types/interfaces/index.ts';
import type { FrameSupportPreimagesBounded, PalletDemocracyReferendumInfo, PalletDemocracyReferendumStatus, PalletDemocracyVoteThreshold } from 'https://deno.land/x/polkadot@0.2.16/types/lookup.ts';
import type { Option } from 'https://deno.land/x/polkadot@0.2.16/types-codec/mod.ts';
...
import { BN, bnSqrt, objectSpread } from 'https://deno.land/x/polkadot@0.2.16/util/mod.ts';
