...
import type { AccountId, Balance, Hash, PropIndex } from 'https://deno.land/x/polkadot@0.2.43/types/interfaces/index.ts';
import type { FrameSupportPreimagesBounded } from 'https://deno.land/x/polkadot@0.2.43/types/lookup.ts';
