...
import type { AccountId, Balance, Hash, PropIndex } from 'https://deno.land/x/polkadot@0.2.41/types/interfaces/index.ts';
import type { FrameSupportPreimagesBounded } from 'https://deno.land/x/polkadot@0.2.41/types/lookup.ts';
