...
import type { AccountId, Balance, Hash, PropIndex } from 'https://deno.land/x/polkadot@0.2.17/types/interfaces/index.ts';
import type { FrameSupportPreimagesBounded } from 'https://deno.land/x/polkadot@0.2.17/types/lookup.ts';
import type { ITuple } from 'https://deno.land/x/polkadot@0.2.17/types/types/index.ts';
