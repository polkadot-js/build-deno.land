...
import type { AccountId, Balance, Hash, PropIndex } from 'https://deno.land/x/polkadot@0.2.40/types/interfaces/index.ts';
import type { FrameSupportPreimagesBounded } from 'https://deno.land/x/polkadot@0.2.40/types/lookup.ts';
import type { ITuple } from 'https://deno.land/x/polkadot@0.2.40/types/types/index.ts';
...
import { isFunction, objectSpread } from 'https://deno.land/x/polkadot@0.2.40/util/mod.ts';
