...
import type { AccountId, Hash, ReferendumInfoTo239, Vote } from 'https://deno.land/x/polkadot@0.2.13/types/interfaces/index.ts';
import type { PalletDemocracyReferendumInfo, PalletDemocracyReferendumStatus, PalletDemocracyVoteVoting } from 'https://deno.land/x/polkadot@0.2.13/types/lookup.ts';
