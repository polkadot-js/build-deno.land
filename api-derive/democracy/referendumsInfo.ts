...
import type { AccountId, ReferendumInfoTo239, Vote } from 'https://deno.land/x/polkadot@0.0.9/types/interfaces/index.ts';
import type { PalletDemocracyReferendumInfo, PalletDemocracyVoteVoting } from 'https://deno.land/x/polkadot@0.0.9/types/lookup.ts';
...
import { isFunction, objectSpread } from 'https://deno.land/x/polkadot@0.0.9/util/mod.ts';
