...
import type { Vec } from 'https://deno.land/x/polkadot@0.0.0-6/types/mod.ts';
import type { AccountId, Balance, BlockNumber, Hash, PropIndex, Proposal, ReferendumIndex, ReferendumInfoTo239, Vote } from 'https://deno.land/x/polkadot@0.0.0-6/types/interfaces.ts';
import type { PalletDemocracyReferendumStatus, PalletDemocracyVoteThreshold } from 'https://deno.land/x/polkadot@0.0.0-6/types/lookup.ts';
