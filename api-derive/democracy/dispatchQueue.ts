...
import type { Option, Vec } from 'https://deno.land/x/polkadot@0.0.0-6/types/mod.ts';
import type { BlockNumber, Call, Hash, ReferendumIndex, Scheduled } from 'https://deno.land/x/polkadot@0.0.0-6/types/interfaces.ts';
import type { FrameSupportScheduleMaybeHashed, PalletSchedulerScheduledV3 } from 'https://deno.land/x/polkadot@0.0.0-6/types/lookup.ts';
...
import { Enum } from 'https://deno.land/x/polkadot@0.0.0-6/types/mod.ts';
import { isFunction, stringToHex } from 'https://deno.land/x/polkadot@0.0.0-6/util/mod.ts';
