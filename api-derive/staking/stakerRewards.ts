...
import type { AccountId, EraIndex } from 'https://deno.land/x/polkadot@0.2.37/types/interfaces/index.ts';
import type { PalletStakingStakingLedger } from 'https://deno.land/x/polkadot@0.2.37/types/lookup.ts';
...
import { BN_BILLION, BN_ZERO, objectSpread } from 'https://deno.land/x/polkadot@0.2.37/util/mod.ts';
