...
import type { PalletStakingStakingLedger } from 'https://deno.land/x/polkadot@0.0.2/types/lookup.ts';
...
import { BN_BILLION, BN_ZERO } from 'https://deno.land/x/polkadot@0.0.2/util/mod.ts';
