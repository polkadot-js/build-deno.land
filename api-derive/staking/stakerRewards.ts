...
import type { PalletStakingStakingLedger } from 'https://deno.land/x/polkadot@0.2.40/types/lookup.ts';
...
import { BN_BILLION, BN_ZERO, objectSpread } from 'https://deno.land/x/polkadot@0.2.40/util/mod.ts';
