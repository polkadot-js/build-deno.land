...
import type { PalletStakingStakingLedger } from 'https://deno.land/x/polkadot@0.0.4-8/types/lookup.ts';
...
import { BN_BILLION, BN_ZERO } from 'https://deno.land/x/polkadot@0.0.4-8/util/mod.ts';
