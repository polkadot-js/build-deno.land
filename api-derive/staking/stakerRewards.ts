...
import type { PalletStakingStakingLedger } from 'https://deno.land/x/polkadot@0.0.1/types/lookup.ts';
...
import { BN_BILLION, BN_ZERO } from 'https://deno.land/x/polkadot@0.0.1/util/mod.ts';
