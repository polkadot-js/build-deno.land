...
import type { PalletStakingStakingLedger } from 'https://deno.land/x/polkadot@0.2.17/types/lookup.ts';
...
import { BN_BILLION, BN_ZERO, objectSpread } from 'https://deno.land/x/polkadot@0.2.17/util/mod.ts';
