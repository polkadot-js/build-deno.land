...
import type { PalletStakingStakingLedger } from 'https://deno.land/x/polkadot@0.0.5/types/lookup.ts';
...
import { BN_BILLION, BN_ZERO } from 'https://deno.land/x/polkadot@0.0.5/util/mod.ts';
