...
import type { PalletStakingStakingLedger } from 'https://deno.land/x/polkadot@0.2.39/types/lookup.ts';
...
import { BN_BILLION, BN_ZERO, objectSpread } from 'https://deno.land/x/polkadot@0.2.39/util/mod.ts';
