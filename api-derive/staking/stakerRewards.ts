...
import type { PalletStakingStakingLedger } from 'https://deno.land/x/polkadot@0.2.10/types/lookup.ts';
...
import { BN_BILLION, BN_ZERO, objectSpread } from 'https://deno.land/x/polkadot@0.2.10/util/mod.ts';
