...
import type { PalletStakingStakingLedger } from 'https://deno.land/x/polkadot@0.2.2/types/lookup.ts';
...
import { BN_BILLION, BN_ZERO, objectSpread } from 'https://deno.land/x/polkadot@0.2.2/util/mod.ts';
