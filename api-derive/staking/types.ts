...
import type { AccountId, Balance, EraIndex, RewardPoint } from 'https://deno.land/x/polkadot@0.0.0-6/types/interfaces.ts';
import type { PalletStakingExposure, PalletStakingRewardDestination, PalletStakingStakingLedger, PalletStakingValidatorPrefs } from 'https://deno.land/x/polkadot@0.0.0-6/types/lookup.ts';
