...
import type { Option } from 'https://deno.land/x/polkadot@0.2.40/types/mod.ts';
import type { AccountId, EraIndex } from 'https://deno.land/x/polkadot@0.2.40/types/interfaces/index.ts';
import type { PalletStakingExposure, PalletStakingNominations, PalletStakingRewardDestination, PalletStakingStakingLedger, PalletStakingValidatorPrefs } from 'https://deno.land/x/polkadot@0.2.40/types/lookup.ts';
