...
import type { EraIndex } from 'https://deno.land/x/polkadot@0.2.8/types/interfaces/index.ts';
...
import { BN_ONE, BN_ZERO } from 'https://deno.land/x/polkadot@0.2.8/util/mod.ts';
