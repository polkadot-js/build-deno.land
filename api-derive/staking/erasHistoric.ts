...
import type { EraIndex } from 'https://deno.land/x/polkadot@0.2.33/types/interfaces/index.ts';
...
import { BN_ONE, BN_ZERO } from 'https://deno.land/x/polkadot@0.2.33/util/mod.ts';
