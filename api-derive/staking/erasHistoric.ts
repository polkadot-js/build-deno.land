...
import type { EraIndex } from 'https://deno.land/x/polkadot@0.2.24/types/interfaces/index.ts';
...
import { BN_ONE, BN_ZERO } from 'https://deno.land/x/polkadot@0.2.24/util/mod.ts';
