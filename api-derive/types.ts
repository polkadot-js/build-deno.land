...
import type { ApiInterfaceRx } from 'https://deno.land/x/polkadot@0.0.0-6/api-base/types.ts';
import type { u32 } from 'https://deno.land/x/polkadot@0.0.0-6/types/mod.ts';
import type { Balance, BlockNumber, BountyIndex, Hash, Proposal, ProposalIndex, SetIndex, Votes } from 'https://deno.land/x/polkadot@0.0.0-6/types/interfaces.ts';
import type { PalletBountiesBounty, PalletTreasuryProposal } from 'https://deno.land/x/polkadot@0.0.0-6/types/lookup.ts';
