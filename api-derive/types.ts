...
import type { ApiInterfaceRx } from 'https://deno.land/x/polkadot/api-base/types.ts';
import type { u32 } from 'https://deno.land/x/polkadot/types/mod.ts';
import type { Balance, BlockNumber, BountyIndex, Hash, Proposal, ProposalIndex, SetIndex, Votes } from 'https://deno.land/x/polkadot/types/interfaces.ts';
