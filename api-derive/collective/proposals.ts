...
import type { Option, u32 } from 'https://deno.land/x/polkadot@0.2.5/types/mod.ts';
import type { Hash, Proposal, Votes } from 'https://deno.land/x/polkadot@0.2.5/types/interfaces/index.ts';
...
export type { Option, u32 } from 'https://deno.land/x/polkadot@0.2.5/types/mod.ts';
export type { Hash, Proposal, Votes } from 'https://deno.land/x/polkadot@0.2.5/types/interfaces/index.ts';
