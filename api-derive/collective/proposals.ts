...
import type { Option, u32 } from 'https://deno.land/x/polkadot@0.2.18/types/mod.ts';
import type { Hash, Proposal, Votes } from 'https://deno.land/x/polkadot@0.2.18/types/interfaces/index.ts';
...
import { isFunction } from 'https://deno.land/x/polkadot@0.2.18/util/mod.ts';
...
export type { Option, u32 } from 'https://deno.land/x/polkadot@0.2.18/types/mod.ts';
export type { Hash, Proposal, Votes } from 'https://deno.land/x/polkadot@0.2.18/types/interfaces/index.ts';
