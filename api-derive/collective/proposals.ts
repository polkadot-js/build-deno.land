...
import type { Hash, Proposal, Votes } from 'https://deno.land/x/polkadot@0.2.14/types/interfaces/index.ts';
...
export type { Option, u32 } from 'https://deno.land/x/polkadot@0.2.14/types/mod.ts';
export type { Hash, Proposal, Votes } from 'https://deno.land/x/polkadot@0.2.14/types/interfaces/index.ts';
