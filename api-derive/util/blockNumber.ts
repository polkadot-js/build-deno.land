...
import type { Compact } from 'https://deno.land/x/polkadot@0.2.30/types/mod.ts';
import type { BlockNumber } from 'https://deno.land/x/polkadot@0.2.30/types/interfaces/index.ts';
