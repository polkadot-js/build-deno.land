...
import type { Bytes, Option } from 'https://deno.land/x/polkadot@0.0.5/types/mod.ts';
import type { BountyIndex } from 'https://deno.land/x/polkadot@0.0.5/types/interfaces/index.ts';
import type { PalletBountiesBounty } from 'https://deno.land/x/polkadot@0.0.5/types/lookup.ts';
