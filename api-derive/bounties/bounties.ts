...
import type { Bytes, Option } from 'https://deno.land/x/polkadot@0.1.0/types/mod.ts';
import type { BountyIndex } from 'https://deno.land/x/polkadot@0.1.0/types/interfaces/index.ts';
import type { PalletBountiesBounty } from 'https://deno.land/x/polkadot@0.1.0/types/lookup.ts';
