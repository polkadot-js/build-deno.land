...
import type { Bytes, Option } from 'https://deno.land/x/polkadot@0.2.1/types/mod.ts';
import type { BountyIndex } from 'https://deno.land/x/polkadot@0.2.1/types/interfaces/index.ts';
import type { PalletBountiesBounty } from 'https://deno.land/x/polkadot@0.2.1/types/lookup.ts';
