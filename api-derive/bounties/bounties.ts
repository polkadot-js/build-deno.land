...
import type { Bytes, Option } from 'https://deno.land/x/polkadot@0.2.34/types/mod.ts';
import type { BountyIndex } from 'https://deno.land/x/polkadot@0.2.34/types/interfaces/index.ts';
import type { PalletBountiesBounty } from 'https://deno.land/x/polkadot@0.2.34/types/lookup.ts';
