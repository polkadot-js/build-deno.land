...
import type { u32, Vec } from 'https://deno.land/x/polkadot@0.0.0-8/types/mod.ts';
import type { AccountId32, Balance, BlockNumber } from 'https://deno.land/x/polkadot@0.0.0-8/types/interfaces.ts';
import type { PalletElectionsPhragmenSeatHolder } from 'https://deno.land/x/polkadot@0.0.0-8/types/lookup.ts';
