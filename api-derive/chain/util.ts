...
import type { QueryableStorage } from 'https://deno.land/x/polkadot@0.2.14/api-base/types/index.ts';
import type { Compact, Vec } from 'https://deno.land/x/polkadot@0.2.14/types/mod.ts';
import type { AccountId, BlockNumber, Header } from 'https://deno.land/x/polkadot@0.2.14/types/interfaces/index.ts';
import type { Codec, IOption } from 'https://deno.land/x/polkadot@0.2.14/types/types/index.ts';
...
export type { BlockNumber } from 'https://deno.land/x/polkadot@0.2.14/types/interfaces/index.ts';
