...
import type { Compact } from 'https://deno.land/x/polkadot@0.0.2/types/mod.ts';
...
export type { BlockNumber } from 'https://deno.land/x/polkadot@0.0.2/types/interfaces/index.ts';
