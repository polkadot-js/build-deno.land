...
import type { QueryableStorage } from 'https://deno.land/x/polkadot@0.2.34/api-base/types/index.ts';
import type { Compact, Vec } from 'https://deno.land/x/polkadot@0.2.34/types/mod.ts';
import type { AccountId, Address, BlockNumber, Header } from 'https://deno.land/x/polkadot@0.2.34/types/interfaces/index.ts';
import type { Codec, IOption } from 'https://deno.land/x/polkadot@0.2.34/types/types/index.ts';
