...
import type { Compact } from 'https://deno.land/x/polkadot@0.0.0-8/types/mod.ts';
import type { BlockNumber } from 'https://deno.land/x/polkadot@0.0.0-8/types/interfaces.ts';
...
export type { BlockNumber } from 'https://deno.land/x/polkadot@0.0.0-8/types/interfaces.ts';
