...
import type { BlockNumber } from 'https://deno.land/x/polkadot/types/interfaces.ts';
...
export type { BlockNumber } from 'https://deno.land/x/polkadot/types/interfaces.ts';
