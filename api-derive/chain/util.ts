...
import type { QueryableStorage } from 'https://deno.land/x/polkadot@0.2.20/api-base/types/index.ts';
import type { Compact, Vec } from 'https://deno.land/x/polkadot@0.2.20/types/mod.ts';
import type { AccountId, BlockNumber, Header } from 'https://deno.land/x/polkadot@0.2.20/types/interfaces/index.ts';
import type { Codec, IOption } from 'https://deno.land/x/polkadot@0.2.20/types/types/index.ts';
...
export type { BlockNumber } from 'https://deno.land/x/polkadot@0.2.20/types/interfaces/index.ts';
