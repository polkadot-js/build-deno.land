...
import type { AccountId, Balance, BalanceLockTo212, BlockNumber, VestingSchedule } from 'https://deno.land/x/polkadot@0.2.12/types/interfaces/index.ts';
import type { PalletBalancesBalanceLock, PalletBalancesReserveData, PalletVestingVestingInfo } from 'https://deno.land/x/polkadot@0.2.12/types/lookup.ts';
...
import { BN, BN_ZERO, bnMax, bnMin, isFunction, objectSpread } from 'https://deno.land/x/polkadot@0.2.12/util/mod.ts';
