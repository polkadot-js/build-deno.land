...
import type { QueryableStorageEntry } from 'https://deno.land/x/polkadot/api-base/types.ts';
import type { AccountData, AccountId, AccountIndex, AccountInfo, Address, Balance, Index } from 'https://deno.land/x/polkadot/types/interfaces.ts';
