...
import type { QueryableStorageEntry } from 'https://deno.land/x/polkadot@0.0.0-5/api-base/types.ts';
import type { AccountData, AccountId, AccountIndex, AccountInfo, Address, Balance, Index } from 'https://deno.land/x/polkadot@0.0.0-5/types/interfaces.ts';
