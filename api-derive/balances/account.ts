...
import type { QueryableStorageEntry } from 'https://deno.land/x/polkadot@0.0.0-8/api-base/types.ts';
import type { AccountData, AccountId, AccountIndex, AccountInfo, Address, Balance, Index } from 'https://deno.land/x/polkadot@0.0.0-8/types/interfaces.ts';
