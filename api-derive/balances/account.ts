...
import type { QueryableStorageEntry } from 'https://deno.land/x/polkadot@0.2.18/api-base/types/index.ts';
import type { AccountData, AccountId, AccountIndex, AccountInfo, Address, Balance, Index } from 'https://deno.land/x/polkadot@0.2.18/types/interfaces/index.ts';
