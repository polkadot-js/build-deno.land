...
import type { PalletBagsListListBag } from 'https://deno.land/x/polkadot@0.2.30/types/lookup.ts';
...
import { BN_ZERO, bnToBn, objectSpread } from 'https://deno.land/x/polkadot@0.2.30/util/mod.ts';
