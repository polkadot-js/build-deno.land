...
import type { Option, u64 } from 'https://deno.land/x/polkadot@0.2.44/types/mod.ts';
import type { PalletBagsListListBag } from 'https://deno.land/x/polkadot@0.2.44/types/lookup.ts';
...
import { BN_ZERO, bnToBn, objectSpread } from 'https://deno.land/x/polkadot@0.2.44/util/mod.ts';
