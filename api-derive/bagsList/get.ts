...
import type { Option, u64 } from 'https://deno.land/x/polkadot@0.2.42/types/mod.ts';
import type { PalletBagsListListBag } from 'https://deno.land/x/polkadot@0.2.42/types/lookup.ts';
...
import { BN_ZERO, bnToBn, objectSpread } from 'https://deno.land/x/polkadot@0.2.42/util/mod.ts';
