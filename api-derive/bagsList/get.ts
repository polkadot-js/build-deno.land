...
import type { Option, u64 } from 'https://deno.land/x/polkadot@0.0.4-8/types/mod.ts';
import type { PalletBagsListListBag } from 'https://deno.land/x/polkadot@0.0.4-8/types/lookup.ts';
...
import { BN_ZERO, bnToBn } from 'https://deno.land/x/polkadot@0.0.4-8/util/mod.ts';
