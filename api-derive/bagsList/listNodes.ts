...
import type { AccountId32 } from 'https://deno.land/x/polkadot@0.2.26/types/interfaces/index.ts';
...
import { nextTick } from 'https://deno.land/x/polkadot@0.2.26/util/mod.ts';
