...
import type { AccountId32 } from 'https://deno.land/x/polkadot@0.2.44/types/interfaces/index.ts';
...
import { nextTick } from 'https://deno.land/x/polkadot@0.2.44/util/mod.ts';
