...
import type { AccountId32 } from 'https://deno.land/x/polkadot@0.2.34/types/interfaces/index.ts';
...
import { nextTick } from 'https://deno.land/x/polkadot@0.2.34/util/mod.ts';
