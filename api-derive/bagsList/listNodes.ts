...
import type { AccountId32 } from 'https://deno.land/x/polkadot@0.0.2/types/interfaces/index.ts';
...
import { nextTick } from 'https://deno.land/x/polkadot@0.0.2/util/mod.ts';
