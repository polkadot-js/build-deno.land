...
import type { DeriveCustom } from 'https://deno.land/x/polkadot@0.2.10/api-base/types/index.ts';
import type { AnyFunction, AnyString } from 'https://deno.land/x/polkadot@0.2.10/types/types/index.ts';
