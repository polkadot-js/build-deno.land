...
import type { DeriveCustom } from 'https://deno.land/x/polkadot@0.2.5/api-base/types/index.ts';
import type { AnyFunction, AnyString } from 'https://deno.land/x/polkadot@0.2.5/types/types/index.ts';
