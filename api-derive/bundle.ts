...
import type { DeriveCustom } from 'https://deno.land/x/polkadot@0.2.40/api-base/types/index.ts';
import type { AnyFunction, AnyString } from 'https://deno.land/x/polkadot@0.2.40/types/types/index.ts';
