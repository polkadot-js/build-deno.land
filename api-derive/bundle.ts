...
import type { DeriveCustom } from 'https://deno.land/x/polkadot@0.2.44/api-base/types/index.ts';
import type { AnyFunction, AnyString } from 'https://deno.land/x/polkadot@0.2.44/types/types/index.ts';
