...
import type { ProposalIndex } from 'https://deno.land/x/polkadot@0.2.45/types/interfaces/index.ts';
import type { PalletTreasuryProposal } from 'https://deno.land/x/polkadot@0.2.45/types/lookup.ts';
