...
import type { ProposalIndex } from 'https://deno.land/x/polkadot@0.0.0-7/types/interfaces.ts';
import type { PalletTreasuryProposal } from 'https://deno.land/x/polkadot@0.0.0-7/types/lookup.ts';
