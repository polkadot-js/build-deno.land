...
import type { ProposalIndex } from 'https://deno.land/x/polkadot@0.0.0-8/types/interfaces.ts';
import type { PalletTreasuryProposal } from 'https://deno.land/x/polkadot@0.0.0-8/types/lookup.ts';
