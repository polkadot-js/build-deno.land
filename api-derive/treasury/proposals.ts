...
import type { ProposalIndex } from 'https://deno.land/x/polkadot@0.2.7/types/interfaces/index.ts';
import type { PalletTreasuryProposal } from 'https://deno.land/x/polkadot@0.2.7/types/lookup.ts';
