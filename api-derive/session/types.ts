...
import type { Option, u32, u64 } from 'https://deno.land/x/polkadot@0.0.0-8/types/mod.ts';
import type { BlockNumber, EraIndex, Moment, SessionIndex } from 'https://deno.land/x/polkadot@0.0.0-8/types/interfaces.ts';
