...
import type { Option, u32, u64 } from 'https://deno.land/x/polkadot@0.0.0-7/types/mod.ts';
import type { BlockNumber, EraIndex, Moment, SessionIndex } from 'https://deno.land/x/polkadot@0.0.0-7/types/interfaces.ts';
