...
import type { ChainUpgrades } from 'https://deno.land/x/polkadot@0.2.35/types/types/index.ts';
...
import { selectableNetworks } from 'https://deno.land/x/polkadot@0.2.35/networks/mod.ts';
import { BN, hexToU8a } from 'https://deno.land/x/polkadot@0.2.35/util/mod.ts';
