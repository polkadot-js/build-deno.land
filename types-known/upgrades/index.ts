...
import type { ChainUpgrades } from 'https://deno.land/x/polkadot@0.2.27/types/types/index.ts';
...
import { selectableNetworks } from 'https://deno.land/x/polkadot@0.2.27/networks/mod.ts';
import { BN, hexToU8a } from 'https://deno.land/x/polkadot@0.2.27/util/mod.ts';
