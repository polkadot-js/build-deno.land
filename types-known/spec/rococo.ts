...
import type { OverrideVersionedType } from 'https://deno.land/x/polkadot@0.2.8/types/types/index.ts';

import { mapXcmTypes } from 'https://deno.land/x/polkadot@0.2.8/types-create/mod.ts';
