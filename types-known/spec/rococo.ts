...
import type { OverrideVersionedType } from 'https://deno.land/x/polkadot@0.2.17/types/types/index.ts';

import { mapXcmTypes } from 'https://deno.land/x/polkadot@0.2.17/types-create/mod.ts';
