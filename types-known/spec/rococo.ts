...
import type { OverrideVersionedType } from 'https://deno.land/x/polkadot@0.1.0/types/types/index.ts';

import { mapXcmTypes } from 'https://deno.land/x/polkadot@0.1.0/types-create/mod.ts';
