...
import type { OverrideVersionedType } from 'https://deno.land/x/polkadot@0.0.6/types/types/index.ts';

import { mapXcmTypes } from 'https://deno.land/x/polkadot@0.0.6/types-create/mod.ts';
