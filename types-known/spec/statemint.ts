...
import type { OverrideVersionedType } from 'https://deno.land/x/polkadot@0.2.22/types/types/index.ts';

import { mapXcmTypes } from 'https://deno.land/x/polkadot@0.2.22/types-create/mod.ts';
