...
import type { OverrideVersionedType } from 'https://deno.land/x/polkadot@0.0.7/types/types/index.ts';

import { mapXcmTypes } from 'https://deno.land/x/polkadot@0.0.7/types-create/mod.ts';
