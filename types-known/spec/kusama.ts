...
import type { OverrideVersionedType } from 'https://deno.land/x/polkadot@0.0.5/types/types/index.ts';

import { mapXcmTypes } from 'https://deno.land/x/polkadot@0.0.5/types-create/mod.ts';
