...
import type { ChainUpgradeVersion, CodecHasher, DefinitionRpc, DefinitionRpcSub, DefinitionsCall, OverrideModuleType, OverrideVersionedType, Registry, RegistryTypes } from 'https://deno.land/x/polkadot@0.0.3/types/types/index.ts';
...
import { bnToBn, objectSpread } from 'https://deno.land/x/polkadot@0.0.3/util/mod.ts';
