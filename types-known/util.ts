...
import type { ChainUpgradeVersion, CodecHasher, DefinitionRpc, DefinitionRpcSub, DefinitionsCall, OverrideModuleType, OverrideVersionedType, Registry, RegistryTypes } from 'https://deno.land/x/polkadot@0.0.2/types/types/index.ts';
...
import { bnToBn, objectSpread } from 'https://deno.land/x/polkadot@0.0.2/util/mod.ts';
