 ...
 *
 * ```javascript
 * import { stringLowerFirst } from 'https://deno.land/x/polkadot@0.0.4-5/util/mod.ts';
 *
 ...
 *
 * ```javascript
 * import { stringUpperFirst } from 'https://deno.land/x/polkadot@0.0.4-5/util/mod.ts';
 *
