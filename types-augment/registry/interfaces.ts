...
import type { BeefyCommitment, BeefyId, BeefyNextAuthoritySet, BeefyPayload, BeefyPayloadId, BeefySignedCommitment, MmrRootHash, ValidatorSetId } from 'https://deno.land/x/polkadot/types/interfaces/beefy/index.ts';
...
import type { ConfigData, MessageId, OverweightIndex, PageCounter, PageIndexData } from 'https://deno.land/x/polkadot/types/interfaces/cumulus/index.ts';
...
import type { EvmAccount, EvmLog, EvmVicinity, ExitError, ExitFatal, ExitReason, ExitRevert, ExitSucceed } from 'https://deno.land/x/polkadot/types/interfaces/evm/index.ts';
