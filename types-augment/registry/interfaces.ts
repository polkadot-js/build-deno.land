...
import type { BeefyAuthoritySet, BeefyCommitment, BeefyId, BeefyNextAuthoritySet, BeefyPayload, BeefyPayloadId, BeefySignedCommitment, MmrRootHash, ValidatorSet, ValidatorSetId } from 'https://deno.land/x/polkadot@0.0.2/types/interfaces/beefy/index.ts';
import type { BenchmarkConfig, BenchmarkList, BenchmarkMetadata, BenchmarkParameter } from 'https://deno.land/x/polkadot@0.0.2/types/interfaces/benchmark/index.ts';
import type { CheckInherentsResult, InherentData, InherentIdentifier } from 'https://deno.land/x/polkadot@0.0.2/types/interfaces/blockbuilder/index.ts';
...
import type { CollationInfo, CollationInfoV1, ConfigData, MessageId, OverweightIndex, PageCounter, PageIndexData } from 'https://deno.land/x/polkadot@0.0.2/types/interfaces/cumulus/index.ts';
...
import type { EvmAccount, EvmCallInfo, EvmCreateInfo, EvmLog, EvmVicinity, ExitError, ExitFatal, ExitReason, ExitRevert, ExitSucceed } from 'https://deno.land/x/polkadot@0.0.2/types/interfaces/evm/index.ts';
...
import type { MmrBatchProof, MmrEncodableOpaqueLeaf, MmrError, MmrLeafBatchProof, MmrLeafIndex, MmrLeafProof, MmrNodeIndex, MmrProof } from 'https://deno.land/x/polkadot@0.0.2/types/interfaces/mmr/index.ts';
...
import type { TransactionSource, TransactionValidity, ValidTransaction } from 'https://deno.land/x/polkadot@0.0.2/types/interfaces/txqueue/index.ts';
