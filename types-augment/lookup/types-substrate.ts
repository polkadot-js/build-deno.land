...
declare module 'https://deno.land/x/polkadot@0.0.0-8/types/lookup.ts' {
  import type { Data } from 'https://deno.land/x/polkadot@0.0.0-8/types/mod.ts';
  import type { BTreeMap, Bytes, Compact, Enum, Null, Option, Result, Set, Struct, Text, U256, U8aFixed, Vec, WrapperKeepOpaque, bool, u128, u16, u32, u64, u8 } from 'https://deno.land/x/polkadot@0.0.0-8/types-codec/mod.ts';
  import type { ITuple } from 'https://deno.land/x/polkadot@0.0.0-8/types-codec/types.ts';
  import type { Vote } from 'https://deno.land/x/polkadot@0.0.0-8/types/interfaces/elections.ts';
  import type { AccountId32, Call, H256, MultiAddress, PerU16, Perbill, Percent, Perquintill } from 'https://deno.land/x/polkadot@0.0.0-8/types/interfaces/runtime.ts';
  import type { Event } from 'https://deno.land/x/polkadot@0.0.0-8/types/interfaces/system.ts';
