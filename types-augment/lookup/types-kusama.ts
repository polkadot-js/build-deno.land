...
import type { Bytes, Compact, Enum, Null, Struct, U8aFixed, Vec, u16, u32, u64 } from 'https://deno.land/x/polkadot@0.2.44/types-codec/mod.ts';
import type { ITuple } from 'https://deno.land/x/polkadot@0.2.44/types-codec/types/index.ts';
import type { H256, PerU16 } from 'https://deno.land/x/polkadot@0.2.44/types/interfaces/runtime/index.ts';
