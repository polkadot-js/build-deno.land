...
export default {
  ...
  FrameSystemEvent: {
    _enum: {
      ...
      TaskStarted: {
        task: 'KitchensinkRuntimeRuntimeTask',
      },
      TaskCompleted: {
        task: 'KitchensinkRuntimeRuntimeTask',
      },
  ...
  /**
   * Lookup30: kitchensink_runtime::RuntimeTask
   **/
  KitchensinkRuntimeRuntimeTask: {
    _enum: {
      ...
      __Unused69: 'Null',
      __Unused70: 'Null',
      TasksExample: 'PalletExampleTasksTask'
    }
  },
  /**
   * Lookup31: pallet_example_tasks::pallet::Task<T>
   **/
  PalletExampleTasksTask: {
    _enum: {
      AddNumberIntoTotal: {
        i: 'u32'
      }
  ...
  /**
   * Lookup39: pallet_asset_tx_payment::pallet::Event<T>
   **/
  ...
  /**
   * Lookup41: pallet_asset_conversion_tx_payment::pallet::Event<T>
   **/
  ...
  /**
   * Lookup49: pallet_staking::pallet::pallet::Event<T>
   **/
  ...
  /**
   * Lookup50: pallet_staking::RewardDestination<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup52: pallet_staking::ValidatorPrefs
   **/
  ...
  /**
   * Lookup54: pallet_staking::Forcing
   **/
  ...
  /**
   * Lookup73: pallet_asset_rate::pallet::Event<T>
   **/
  ...
  /**
   * Lookup75: pallet_contracts::pallet::Event<T>
   **/
  ...
  /**
   * Lookup76: pallet_contracts::Origin<kitchensink_runtime::Runtime>
   **/
  ...
  /**
   * Lookup77: kitchensink_runtime::Runtime
   **/
  ...
  /**
   * Lookup79: pallet_im_online::pallet::Event<T>
   **/
  PalletImOnlineEvent: {
    _enum: {
      HeartbeatReceived: {
  ...
  /**
   * Lookup80: pallet_im_online::sr25519::app_sr25519::Public
   **/
  ...
  /**
   * Lookup84: sp_staking::Exposure<sp_core::crypto::AccountId32, Balance>
   **/
  SpStakingExposure: {
    total: 'Compact<u128>',
    own: 'Compact<u128>',
  ...
  /**
   * Lookup87: sp_staking::IndividualExposure<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup91: pallet_society::pallet::Event<T, I>
   **/
  PalletSocietyEvent: {
    _enum: {
      Founded: {
  ...
  /**
   * Lookup93: pallet_society::GroupParams<Balance>
   **/
  ...
  /**
   * Lookup94: pallet_recovery::pallet::Event<T>
   **/
  PalletRecoveryEvent: {
    _enum: {
      RecoveryCreated: {
  ...
  /**
   * Lookup95: pallet_vesting::pallet::Event<T>
   **/
  PalletVestingEvent: {
    _enum: {
      VestingUpdated: {
  ...
  /**
   * Lookup99: pallet_glutton::pallet::Event
   **/
  PalletGluttonEvent: {
    _enum: {
      PalletInitialized: {
  ...
  /**
   * Lookup102: pallet_proxy::pallet::Event<T>
   **/
  PalletProxyEvent: {
    _enum: {
      ProxyExecuted: {
  ...
  /**
   * Lookup103: kitchensink_runtime::ProxyType
   **/
  ...
  /**
   * Lookup108: pallet_tips::pallet::Event<T, I>
   **/
  PalletTipsEvent: {
    _enum: {
      NewTip: {
  ...
  /**
   * Lookup109: pallet_assets::pallet::Event<T, I>
   **/
  PalletAssetsEvent: {
    _enum: {
      Created: {
  ...
  /**
   * Lookup111: pallet_lottery::pallet::Event<T>
   **/
  PalletLotteryEvent: {
    _enum: {
      LotteryStarted: 'Null',
  ...
  /**
   * Lookup113: pallet_nis::pallet::Event<T>
   **/
  PalletNisEvent: {
    _enum: {
      BidPlaced: {
  ...
  /**
   * Lookup115: pallet_uniques::pallet::Event<T, I>
   **/
  PalletUniquesEvent: {
    _enum: {
      Created: {
  ...
  /**
   * Lookup120: pallet_nfts::pallet::Event<T, I>
   **/
  PalletNftsEvent: {
    _enum: {
      Created: {
  ...
  /**
   * Lookup122: pallet_nfts::types::AttributeNamespace<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup124: pallet_nfts::types::PriceWithDirection<Amount>
   **/
  ...
  /**
   * Lookup125: pallet_nfts::types::PriceDirection
   **/
  PalletNftsPriceDirection: {
    _enum: ['Send', 'Receive']
  },
  /**
   * Lookup126: pallet_nfts::types::PalletAttributes<CollectionId>
   **/
  ...
  /**
   * Lookup127: pallet_nft_fractionalization::pallet::Event<T>
   **/
  ...
  /**
   * Lookup128: pallet_salary::pallet::Event<T, I>
   **/
  PalletSalaryEvent: {
    _enum: {
      Inducted: {
  ...
  /**
   * Lookup129: pallet_core_fellowship::pallet::Event<T, I>
   **/
  ...
  /**
   * Lookup130: pallet_core_fellowship::ParamsType<Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup133: pallet_core_fellowship::Wish
   **/
  PalletCoreFellowshipWish: {
    _enum: ['Retention', 'Promotion']
  },
  /**
   * Lookup136: pallet_transaction_storage::pallet::Event<T>
   **/
  ...
  /**
   * Lookup137: pallet_bags_list::pallet::Event<T, I>
   **/
  PalletBagsListEvent: {
    _enum: {
      Rebagged: {
  ...
  /**
   * Lookup138: pallet_state_trie_migration::pallet::Event<T>
   **/
  ...
  /**
   * Lookup139: pallet_state_trie_migration::pallet::MigrationCompute
   **/
  PalletStateTrieMigrationMigrationCompute: {
    _enum: ['Signed', 'Auto']
  },
  /**
   * Lookup140: pallet_state_trie_migration::pallet::Error<T>
   **/
  PalletStateTrieMigrationError: {
    _enum: ['MaxSignedLimits', 'KeyTooLong', 'NotEnoughFunds', 'BadWitness', 'SignedMigrationNotAllowed', 'BadChildRoot']
  },
  /**
   * Lookup141: pallet_child_bounties::pallet::Event<T>
   **/
  ...
  /**
   * Lookup143: frame_support::traits::preimages::Bounded<kitchensink_runtime::RuntimeCall, sp_runtime::traits::BlakeTwo256>
   **/
  ...
  /**
   * Lookup151: kitchensink_runtime::OriginCaller
   **/
  ...
  /**
   * Lookup153: pallet_collective::RawOrigin<sp_core::crypto::AccountId32, I>
   **/
  ...
  /**
   * Lookup173: pallet_election_provider_multi_phase::RawSolution<kitchensink_runtime::NposSolution16>
   **/
  ...
  /**
   * Lookup174: kitchensink_runtime::NposSolution16
   **/
  ...
  /**
   * Lookup230: pallet_staking::pallet::pallet::Call<T>
   **/
  ...
  /**
   * Lookup246: pallet_elections_phragmen::pallet::Call<T>
   **/
  ...
  /**
   * Lookup247: pallet_elections_phragmen::Renouncing
   **/
  ...
  /**
   * Lookup248: pallet_membership::pallet::Call<T, I>
   **/
  ...
  /**
   * Lookup262: pallet_asset_rate::pallet::Call<T>
   **/
  PalletAssetRateCall: {
    _enum: {
      create: {
  ...
  /**
   * Lookup265: pallet_contracts::wasm::Determinism
   **/
  ...
  /**
   * Lookup269: pallet_im_online::sr25519::app_sr25519::Signature
   **/
  ...
  /**
   * Lookup272: pallet_identity::legacy::IdentityInfo<FieldLimit>
   **/
  ...
  /**
   * Lookup311: pallet_recovery::pallet::Call<T>
   **/
  PalletRecoveryCall: {
    _enum: {
      as_recovered: {
  ...
  /**
   * Lookup312: pallet_vesting::pallet::Call<T>
   **/
  PalletVestingCall: {
    _enum: {
      vest: 'Null',
  ...
  /**
   * Lookup313: pallet_vesting::vesting_info::VestingInfo<Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup316: pallet_glutton::pallet::Call<T>
   **/
  PalletGluttonCall: {
    _enum: {
      initialize_pallet: {
  ...
  /**
   * Lookup399: pallet_nomination_pools::CommissionClaimPermission<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup401: pallet_ranked_collective::pallet::Call<T, I>
   **/
  ...
  /**
   * Lookup402: pallet_asset_conversion::pallet::Call<T>
   **/
  ...
  /**
   * Lookup403: pallet_asset_conversion::types::NativeOrAssetId<AssetId>
   **/
  ...
  /**
   * Lookup406: pallet_fast_unstake::pallet::Call<T>
   **/
  ...
  /**
   * Lookup407: pallet_message_queue::pallet::Call<T>
   **/
  ...
  /**
   * Lookup408: frame_benchmarking_pallet_pov::pallet::Call<T>
   **/
  FrameBenchmarkingPalletPovCall: {
    _enum: ['emit_event', 'noop']
  },
  /**
   * Lookup409: pallet_tx_pause::pallet::Call<T>
   **/
  PalletTxPauseCall: {
    _enum: {
      pause: {
  ...
  /**
   * Lookup411: pallet_safe_mode::pallet::Call<T>
   **/
  PalletSafeModeCall: {
    _enum: {
      enter: 'Null',
  ...
  /**
   * Lookup412: pallet_broker::pallet::Call<T>
   **/
  PalletBrokerCall: {
    _enum: {
      configure: {
  ...
  /**
   * Lookup413: pallet_broker::types::ConfigRecord<BlockNumber, RelayBlockNumber>
   **/
  ...
  /**
   * Lookup415: pallet_broker::types::ScheduleItem
   **/
  ...
  /**
   * Lookup416: pallet_broker::core_mask::CoreMask
   **/
  PalletBrokerCoreMask: '[u8;10]',
  /**
   * Lookup417: pallet_broker::coretime_interface::CoreAssignment
   **/
  ...
  /**
   * Lookup419: pallet_broker::types::RegionId
   **/
  ...
  /**
   * Lookup420: pallet_broker::types::Finality
   **/
  PalletBrokerFinality: {
    _enum: ['Provisional', 'Final']
  },
  /**
   * Lookup421: pallet_mixnet::pallet::Call<T>
   **/
  PalletMixnetCall: {
    _enum: {
      register: {
  ...
  /**
   * Lookup422: pallet_mixnet::Registration<BlockNumber, pallet_mixnet::BoundedMixnode<bounded_collections::bounded_vec::BoundedVec<bounded_collections::bounded_vec::BoundedVec<T, S>, S>>>
   **/
  ...
  /**
   * Lookup423: pallet_mixnet::BoundedMixnode<bounded_collections::bounded_vec::BoundedVec<bounded_collections::bounded_vec::BoundedVec<T, S>, S>>
   **/
  ...
  /**
   * Lookup426: sp_mixnet::types::app::Signature
   **/
  ...
  /**
   * Lookup428: pallet_conviction_voting::types::Tally<Votes, Total>
   **/
  ...
  /**
   * Lookup429: pallet_remark::pallet::Event<T>
   **/
  PalletRemarkEvent: {
    _enum: {
      Stored: {
  ...
  /**
   * Lookup430: pallet_root_testing::pallet::Event<T>
   **/
  PalletRootTestingEvent: {
    _enum: ['DefensiveTestCall']
  },
  /**
   * Lookup431: pallet_conviction_voting::pallet::Event<T, I>
   **/
  ...
  /**
   * Lookup432: pallet_whitelist::pallet::Event<T>
   **/
  ...
  /**
   * Lookup434: frame_support::dispatch::PostDispatchInfo
   **/
  ...
  /**
   * Lookup436: sp_runtime::DispatchErrorWithPostInfo<frame_support::dispatch::PostDispatchInfo>
   **/
  ...
  /**
   * Lookup438: pallet_alliance::pallet::Event<T, I>
   **/
  PalletAllianceEvent: {
    _enum: {
      NewRuleSet: {
  ...
  /**
   * Lookup439: pallet_nomination_pools::pallet::Event<T>
   **/
  ...
  /**
   * Lookup441: pallet_ranked_collective::Tally<T, I, M>
   **/
  ...
  /**
   * Lookup442: pallet_ranked_collective::pallet::Event<T, I>
   **/
  ...
  /**
   * Lookup443: pallet_ranked_collective::VoteRecord
   **/
  ...
  /**
   * Lookup444: pallet_asset_conversion::pallet::Event<T>
   **/
  ...
  /**
   * Lookup447: pallet_fast_unstake::pallet::Event<T>
   **/
  ...
  /**
   * Lookup448: pallet_message_queue::pallet::Event<T>
   **/
  ...
  /**
   * Lookup449: frame_support::traits::messages::ProcessMessageError
   **/
  ...
  /**
   * Lookup450: frame_benchmarking_pallet_pov::pallet::Event<T>
   **/
  FrameBenchmarkingPalletPovEvent: {
    _enum: ['TestEvent']
  },
  /**
   * Lookup451: pallet_tx_pause::pallet::Event<T>
   **/
  PalletTxPauseEvent: {
    _enum: {
      CallPaused: {
  ...
  /**
   * Lookup452: pallet_safe_mode::pallet::Event<T>
   **/
  PalletSafeModeEvent: {
    _enum: {
      Entered: {
  ...
  /**
   * Lookup453: pallet_safe_mode::pallet::ExitReason
   **/
  PalletSafeModeExitReason: {
    _enum: ['Timeout', 'Force']
  },
  /**
   * Lookup454: pallet_statement::pallet::Event<T>
   **/
  ...
  /**
   * Lookup455: sp_statement_store::Statement
   **/
  ...
  /**
   * Lookup457: sp_statement_store::Proof
   **/
  ...
  /**
   * Lookup461: pallet_broker::pallet::Event<T>
   **/
  PalletBrokerEvent: {
    _enum: {
      Purchased: {
  ...
  /**
   * Lookup466: pallet_skip_feeless_payment::pallet::Event<T>
   **/
  ...
  /**
   * Lookup469: frame_system::LastRuntimeUpgradeInfo
   **/
  ...
  /**
   * Lookup471: frame_system::limits::BlockWeights
   **/
  ...
  /**
   * Lookup472: frame_support::dispatch::PerDispatchClass<frame_system::limits::WeightsPerClass>
   **/
  ...
  /**
   * Lookup473: frame_system::limits::WeightsPerClass
   **/
  ...
  /**
   * Lookup474: frame_system::limits::BlockLength
   **/
  FrameSystemLimitsBlockLength: {
    max: 'FrameSupportDispatchPerDispatchClassU32'
  },
  /**
   * Lookup475: frame_support::dispatch::PerDispatchClass<T>
   **/
  ...
  /**
   * Lookup476: sp_weights::RuntimeDbWeight
   **/
  ...
  /**
   * Lookup477: sp_version::RuntimeVersion
   **/
  ...
  /**
   * Lookup481: frame_system::pallet::Error<T>
   **/
  FrameSystemError: {
    _enum: ['InvalidSpecName', 'SpecVersionNeedsToIncrease', 'FailedToExtractRuntimeVersion', 'NonDefaultComposite', 'NonZeroRefCount', 'CallFiltered', 'InvalidTask', 'FailedTask']
  },
  /**
   * Lookup482: pallet_utility::pallet::Error<T>
   **/
  PalletUtilityError: {
    _enum: ['TooManyCalls']
  },
  ...
  /**
   * Lookup500: pallet_indices::pallet::Error<T>
   **/
  PalletIndicesError: {
    _enum: ['NotAssigned', 'NotOwner', 'InUse', 'NotTransfer', 'Permanent']
  },
  /**
   * Lookup502: pallet_balances::types::BalanceLock<Balance>
   **/
  ...
  /**
   * Lookup503: pallet_balances::types::Reasons
   **/
  PalletBalancesReasons: {
    _enum: ['Fee', 'Misc', 'All']
  },
  /**
   * Lookup506: pallet_balances::types::ReserveData<ReserveIdentifier, Balance>
   **/
  ...
  /**
   * Lookup509: pallet_balances::types::IdAmount<kitchensink_runtime::RuntimeHoldReason, Balance>
   **/
  ...
  /**
   * Lookup510: kitchensink_runtime::RuntimeHoldReason
   **/
  ...
  /**
   * Lookup511: pallet_contracts::pallet::HoldReason
   **/
  PalletContractsHoldReason: {
    _enum: ['CodeUploadDepositReserve', 'StorageDepositReserve']
  },
  /**
   * Lookup512: pallet_preimage::pallet::HoldReason
   **/
  PalletPreimageHoldReason: {
    _enum: ['Preimage']
  },
  /**
   * Lookup513: pallet_nis::pallet::HoldReason
   **/
  PalletNisHoldReason: {
    _enum: ['NftReceipt']
  },
  /**
   * Lookup514: pallet_nft_fractionalization::pallet::HoldReason
   **/
  PalletNftFractionalizationHoldReason: {
    _enum: ['Fractionalized']
  },
  /**
   * Lookup515: pallet_transaction_storage::pallet::HoldReason
   **/
  PalletTransactionStorageHoldReason: {
    _enum: ['StorageFeeHold']
  },
  /**
   * Lookup516: pallet_safe_mode::pallet::HoldReason
   **/
  PalletSafeModeHoldReason: {
    _enum: ['EnterOrExtend']
  },
  /**
   * Lookup519: pallet_balances::types::IdAmount<kitchensink_runtime::RuntimeFreezeReason, Balance>
   **/
  ...
  /**
   * Lookup520: kitchensink_runtime::RuntimeFreezeReason
   **/
  ...
  /**
   * Lookup521: pallet_nomination_pools::pallet::FreezeReason
   **/
  ...
  /**
   * Lookup534: pallet_election_provider_multi_phase::signed::SignedSubmission<sp_core::crypto::AccountId32, Balance, kitchensink_runtime::NposSolution16>
   **/
  ...
  /**
   * Lookup538: pallet_staking::UnlockChunk<Balance>
   **/
  ...
  /**
   * Lookup541: pallet_staking::Nominations<T>
   **/
  ...
  /**
   * Lookup545: sp_staking::PagedExposureMetadata<Balance>
   **/
  ...
  /**
   * Lookup547: sp_staking::ExposurePage<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup548: pallet_staking::EraRewardPoints<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup553: pallet_staking::UnappliedSlash<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup559: pallet_staking::pallet::pallet::Error<T>
   **/
  ...
  /**
   * Lookup563: sp_core::crypto::KeyTypeId
   **/
  SpCoreCryptoKeyTypeId: '[u8;4]',
  /**
   * Lookup564: pallet_session::pallet::Error<T>
   **/
  PalletSessionError: {
    _enum: ['InvalidProof', 'NoAssociatedValidatorId', 'DuplicatedKey', 'NoKeys', 'NoAccount']
  },
  /**
   * Lookup570: pallet_democracy::types::ReferendumInfo<BlockNumber, frame_support::traits::preimages::Bounded<kitchensink_runtime::RuntimeCall, sp_runtime::traits::BlakeTwo256>, Balance>
   **/
  ...
  /**
   * Lookup571: pallet_democracy::types::ReferendumStatus<BlockNumber, frame_support::traits::preimages::Bounded<kitchensink_runtime::RuntimeCall, sp_runtime::traits::BlakeTwo256>, Balance>
   **/
  ...
  /**
   * Lookup593: pallet_grandpa::StoredState<N>
   **/
  ...
  /**
   * Lookup594: pallet_grandpa::StoredPendingChange<N, Limit>
   **/
  ...
  /**
   * Lookup596: pallet_grandpa::pallet::Error<T>
   **/
  PalletGrandpaError: {
    _enum: ['PauseFailed', 'ResumeFailed', 'ChangePending', 'TooSoon', 'InvalidKeyOwnershipProof', 'InvalidEquivocationProof', 'DuplicateOffenceReport']
  },
  /**
   * Lookup597: pallet_treasury::Proposal<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup599: pallet_treasury::SpendStatus<AssetKind, AssetBalance, sp_core::crypto::AccountId32, BlockNumber, PaymentId>
   **/
  ...
  /**
   * Lookup600: pallet_treasury::PaymentState<Id>
   **/
  ...
  /**
   * Lookup601: frame_support::PalletId
   **/
  FrameSupportPalletId: '[u8;8]',
  /**
   * Lookup602: pallet_treasury::pallet::Error<T, I>
   **/
  PalletTreasuryError: {
  ...
  /**
   * Lookup605: pallet_contracts::wasm::CodeInfo<T>
   **/
  ...
  /**
   * Lookup606: pallet_contracts::storage::ContractInfo<T>
   **/
  ...
  /**
   * Lookup611: pallet_contracts::storage::DeletionQueueManager<T>
   **/
  ...
  /**
   * Lookup613: pallet_contracts::schedule::Schedule<T>
   **/
  ...
  /**
   * Lookup614: pallet_contracts::schedule::Limits
   **/
  ...
  /**
   * Lookup615: pallet_contracts::schedule::InstructionWeights<T>
   **/
  PalletContractsScheduleInstructionWeights: {
    base: 'u32'
  },
  /**
   * Lookup616: pallet_contracts::schedule::HostFnWeights<T>
   **/
  ...
  /**
   * Lookup617: pallet_contracts::Environment<T>
   **/
  ...
  /**
   * Lookup618: pallet_contracts::EnvironmentType<sp_core::crypto::AccountId32>
   **/
  PalletContractsEnvironmentTypeAccountId32: 'Null',
  /**
   * Lookup619: pallet_contracts::EnvironmentType<T>
   **/
  PalletContractsEnvironmentTypeU128: 'Null',
  /**
   * Lookup620: pallet_contracts::EnvironmentType<primitive_types::H256>
   **/
  PalletContractsEnvironmentTypeH256: 'Null',
  /**
   * Lookup621: pallet_contracts::EnvironmentType<sp_runtime::traits::BlakeTwo256>
   **/
  PalletContractsEnvironmentTypeBlakeTwo256: 'Null',
  /**
   * Lookup622: pallet_contracts::EnvironmentType<T>
   **/
  PalletContractsEnvironmentTypeU64: 'Null',
  /**
   * Lookup623: pallet_contracts::EnvironmentType<T>
   **/
  PalletContractsEnvironmentTypeU32: 'Null',
  /**
   * Lookup624: pallet_contracts::pallet::Error<T>
   **/
  ...
  /**
   * Lookup625: pallet_sudo::pallet::Error<T>
   **/
  PalletSudoError: {
    _enum: ['RequireSudo']
  },
  ...
  /**
   * Lookup634: pallet_identity::types::Registration<Balance, MaxJudgements, pallet_identity::legacy::IdentityInfo<FieldLimit>>
   **/
  ...
  /**
   * Lookup642: pallet_identity::types::RegistrarInfo<Balance, sp_core::crypto::AccountId32, IdField>
   **/
  ...
  /**
   * Lookup644: pallet_identity::pallet::Error<T>
   **/
  PalletIdentityError: {
  ...
  /**
   * Lookup645: pallet_society::MemberRecord
   **/
  ...
  /**
   * Lookup647: pallet_society::VouchingStatus
   **/
  PalletSocietyVouchingStatus: {
    _enum: ['Vouching', 'Banned']
  },
  /**
   * Lookup648: pallet_society::PayoutRecord<Balance, bounded_collections::bounded_vec::BoundedVec<T, S>>
   **/
  ...
  /**
   * Lookup653: pallet_society::Bid<sp_core::crypto::AccountId32, Balance>
   **/
  PalletSocietyBid: {
    who: 'AccountId32',
  ...
  /**
   * Lookup654: pallet_society::BidKind<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup656: pallet_society::Candidacy<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup657: pallet_society::Tally
   **/
  PalletSocietyTally: {
    approvals: 'u32',
    rejections: 'u32'
  ...
  /**
   * Lookup661: pallet_society::IntakeRecord<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup663: pallet_society::pallet::Error<T, I>
   **/
  PalletSocietyError: {
  ...
  /**
   * Lookup664: pallet_recovery::RecoveryConfig<BlockNumber, Balance, bounded_collections::bounded_vec::BoundedVec<sp_core::crypto::AccountId32, S>>
   **/
  ...
  /**
   * Lookup666: pallet_recovery::ActiveRecovery<BlockNumber, Balance, bounded_collections::bounded_vec::BoundedVec<sp_core::crypto::AccountId32, S>>
   **/
  ...
  /**
   * Lookup667: pallet_recovery::pallet::Error<T>
   **/
  PalletRecoveryError: {
  ...
  /**
   * Lookup670: pallet_vesting::Releases
   **/
  PalletVestingReleases: {
    _enum: ['V0', 'V1']
  },
  /**
   * Lookup671: pallet_vesting::pallet::Error<T>
   **/
  PalletVestingError: {
    _enum: ['NotVesting', 'AtMaxVestingSchedules', 'AmountLow', 'ScheduleIndexOutOfBounds', 'InvalidScheduleParams']
  },
  /**
   * Lookup674: pallet_scheduler::Scheduled<Name, frame_support::traits::preimages::Bounded<kitchensink_runtime::RuntimeCall, sp_runtime::traits::BlakeTwo256>, BlockNumber, kitchensink_runtime::OriginCaller, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup678: pallet_glutton::pallet::Error<T>
   **/
  PalletGluttonError: {
    _enum: ['AlreadyInitialized', 'InsaneLimit']
  },
  /**
   * Lookup679: pallet_preimage::OldRequestStatus<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup681: pallet_preimage::RequestStatus<sp_core::crypto::AccountId32, frame_support::traits::tokens::fungible::HoldConsideration<A, F, R, D>>
   **/
  ...
  /**
   * Lookup690: pallet_proxy::ProxyDefinition<sp_core::crypto::AccountId32, kitchensink_runtime::ProxyType, BlockNumber>
   **/
  ...
  /**
   * Lookup694: pallet_proxy::Announcement<sp_core::crypto::AccountId32, primitive_types::H256, BlockNumber>
   **/
  ...
  /**
   * Lookup696: pallet_proxy::pallet::Error<T>
   **/
  PalletProxyError: {
    _enum: ['TooMany', 'NotFound', 'NotProxy', 'Unproxyable', 'Duplicate', 'NoPermission', 'Unannounced', 'NoSelfProxy']
  },
  /**
   * Lookup698: pallet_multisig::Multisig<BlockNumber, Balance, sp_core::crypto::AccountId32, MaxApprovals>
   **/
  ...
  /**
   * Lookup699: pallet_multisig::pallet::Error<T>
   **/
  PalletMultisigError: {
    _enum: ['MinimumThreshold', 'AlreadyApproved', 'NoApprovalsNeeded', 'TooFewSignatories', 'TooManySignatories', 'SignatoriesOutOfOrder', 'SenderInSignatories', 'NotFound', 'NotOwner', 'NoTimepoint', 'WrongTimepoint', 'UnexpectedTimepoint', 'MaxWeightTooLow', 'AlreadyStored']
  },
  /**
   * Lookup700: pallet_bounties::Bounty<sp_core::crypto::AccountId32, Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup701: pallet_bounties::BountyStatus<sp_core::crypto::AccountId32, BlockNumber>
   **/
  ...
  /**
   * Lookup703: pallet_bounties::pallet::Error<T, I>
   **/
  PalletBountiesError: {
    _enum: ['InsufficientProposersBalance', 'InvalidIndex', 'ReasonTooBig', 'UnexpectedStatus', 'RequireCurator', 'InvalidValue', 'InvalidFee', 'PendingPayout', 'Premature', 'HasActiveChildBounty', 'TooManyQueued']
  },
  /**
   * Lookup704: pallet_tips::OpenTip<sp_core::crypto::AccountId32, Balance, BlockNumber, primitive_types::H256>
   **/
  PalletTipsOpenTip: {
    reason: 'H256',
    who: 'AccountId32',
  ...
  /**
   * Lookup705: pallet_tips::pallet::Error<T, I>
   **/
  PalletTipsError: {
    _enum: ['ReasonTooBig', 'AlreadyKnown', 'UnknownTip', 'MaxTipAmountExceeded', 'NotFinder', 'StillOpen', 'Premature']
  },
  /**
   * Lookup706: pallet_assets::types::AssetDetails<Balance, sp_core::crypto::AccountId32, DepositBalance>
   **/
  ...
  /**
   * Lookup707: pallet_assets::types::AssetStatus
   **/
  PalletAssetsAssetStatus: {
    _enum: ['Live', 'Frozen', 'Destroying']
  },
  /**
   * Lookup708: pallet_assets::types::AssetAccount<Balance, DepositBalance, Extra, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup709: pallet_assets::types::AccountStatus
   **/
  PalletAssetsAccountStatus: {
    _enum: ['Liquid', 'Frozen', 'Blocked']
  },
  /**
   * Lookup710: pallet_assets::types::ExistenceReason<Balance, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup712: pallet_assets::types::Approval<Balance, DepositBalance>
   **/
  ...
  /**
   * Lookup713: pallet_assets::types::AssetMetadata<DepositBalance, bounded_collections::bounded_vec::BoundedVec<T, S>>
   **/
  ...
  /**
   * Lookup715: pallet_assets::pallet::Error<T, I>
   **/
  PalletAssetsError: {
  ...
  /**
   * Lookup717: pallet_lottery::LotteryConfig<BlockNumber, Balance>
   **/
  ...
  /**
   * Lookup721: pallet_lottery::pallet::Error<T>
   **/
  PalletLotteryError: {
    _enum: ['NotConfigured', 'InProgress', 'AlreadyEnded', 'InvalidCall', 'AlreadyParticipating', 'TooManyCalls', 'EncodingFailed']
  },
  /**
   * Lookup724: pallet_nis::pallet::Bid<Balance, sp_core::crypto::AccountId32>
   **/
  PalletNisBid: {
    amount: 'u128',
    who: 'AccountId32'
  ...
  /**
   * Lookup726: pallet_nis::pallet::SummaryRecord<BlockNumber, Balance>
   **/
  ...
  /**
   * Lookup727: pallet_nis::pallet::ReceiptRecord<sp_core::crypto::AccountId32, BlockNumber, Balance>
   **/
  ...
  /**
   * Lookup729: pallet_nis::pallet::Error<T>
   **/
  PalletNisError: {
  ...
  /**
   * Lookup730: pallet_uniques::types::CollectionDetails<sp_core::crypto::AccountId32, DepositBalance>
   **/
  ...
  /**
   * Lookup732: pallet_uniques::types::ItemDetails<sp_core::crypto::AccountId32, DepositBalance>
   **/
  ...
  /**
   * Lookup733: pallet_uniques::types::CollectionMetadata<DepositBalance, StringLimit>
   **/
  ...
  /**
   * Lookup734: pallet_uniques::types::ItemMetadata<DepositBalance, StringLimit>
   **/
  ...
  /**
   * Lookup738: pallet_uniques::pallet::Error<T, I>
   **/
  PalletUniquesError: {
  ...
  /**
   * Lookup739: pallet_nfts::types::CollectionDetails<sp_core::crypto::AccountId32, DepositBalance>
   **/
  ...
  /**
   * Lookup741: pallet_nfts::types::CollectionRole
   **/
  PalletNftsCollectionRole: {
    _enum: ['__Unused0', 'Issuer', 'Freezer', '__Unused3', 'Admin']
  },
  /**
   * Lookup742: pallet_nfts::types::ItemDetails<sp_core::crypto::AccountId32, pallet_nfts::types::ItemDeposit<DepositBalance, sp_core::crypto::AccountId32>, bounded_collections::bounded_btree_map::BoundedBTreeMap<sp_core::crypto::AccountId32, Option<T>, S>>
   **/
  ...
  /**
   * Lookup743: pallet_nfts::types::ItemDeposit<DepositBalance, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup748: pallet_nfts::types::CollectionMetadata<Deposit, StringLimit>
   **/
  ...
  /**
   * Lookup749: pallet_nfts::types::ItemMetadata<pallet_nfts::types::ItemMetadataDeposit<DepositBalance, sp_core::crypto::AccountId32>, StringLimit>
   **/
  ...
  /**
   * Lookup750: pallet_nfts::types::ItemMetadataDeposit<DepositBalance, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup753: pallet_nfts::types::AttributeDeposit<DepositBalance, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup756: pallet_nfts::types::PendingSwap<CollectionId, ItemId, pallet_nfts::types::PriceWithDirection<Amount>, Deadline>
   **/
  ...
  /**
   * Lookup760: pallet_nft_fractionalization::types::Details<AssetId, Fractions, Deposit, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup761: pallet_nft_fractionalization::pallet::Error<T>
   **/
  PalletNftFractionalizationError: {
    _enum: ['IncorrectAssetId', 'NoPermission', 'NftNotFound', 'NftNotFractionalized']
  },
  /**
   * Lookup762: pallet_salary::StatusType<CycleIndex, BlockNumber, Balance>
   **/
  ...
  /**
   * Lookup763: pallet_salary::ClaimantStatus<CycleIndex, Balance, Id>
   **/
  ...
  /**
   * Lookup764: pallet_salary::ClaimState<Balance, Id>
   **/
  ...
  /**
   * Lookup765: pallet_salary::pallet::Error<T, I>
   **/
  PalletSalaryError: {
  ...
  /**
   * Lookup766: pallet_core_fellowship::MemberStatus<BlockNumber>
   **/
  ...
  /**
   * Lookup768: pallet_core_fellowship::pallet::Error<T, I>
   **/
  ...
  /**
   * Lookup770: pallet_transaction_storage::TransactionInfo
   **/
  ...
  /**
   * Lookup772: pallet_transaction_storage::pallet::Error<T>
   **/
  ...
  /**
   * Lookup773: pallet_bags_list::list::Node<T, I>
   **/
  ...
  /**
   * Lookup774: pallet_bags_list::list::Bag<T, I>
   **/
  ...
  /**
   * Lookup776: pallet_bags_list::pallet::Error<T, I>
   **/
  PalletBagsListError: {
    _enum: {
  ...
  /**
   * Lookup777: pallet_bags_list::list::ListError
   **/
  PalletBagsListListListError: {
    _enum: ['Duplicate', 'NotHeavier', 'NotInSameBag', 'NodeNotFound']
  },
  /**
   * Lookup778: pallet_child_bounties::ChildBounty<sp_core::crypto::AccountId32, Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup779: pallet_child_bounties::ChildBountyStatus<sp_core::crypto::AccountId32, BlockNumber>
   **/
  ...
  /**
   * Lookup780: pallet_child_bounties::pallet::Error<T>
   **/
  PalletChildBountiesError: {
    _enum: ['ParentBountyNotActive', 'InsufficientBountyBalance', 'TooManyChildBounties']
  },
  /**
   * Lookup781: pallet_referenda::types::ReferendumInfo<TrackId, kitchensink_runtime::OriginCaller, Moment, frame_support::traits::preimages::Bounded<kitchensink_runtime::RuntimeCall, sp_runtime::traits::BlakeTwo256>, Balance, pallet_conviction_voting::types::Tally<Votes, Total>, sp_core::crypto::AccountId32, ScheduleAddress>
   **/
  ...
  /**
   * Lookup782: pallet_referenda::types::ReferendumStatus<TrackId, kitchensink_runtime::OriginCaller, Moment, frame_support::traits::preimages::Bounded<kitchensink_runtime::RuntimeCall, sp_runtime::traits::BlakeTwo256>, Balance, pallet_conviction_voting::types::Tally<Votes, Total>, sp_core::crypto::AccountId32, ScheduleAddress>
   **/
  ...
  /**
   * Lookup783: pallet_referenda::types::Deposit<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup786: pallet_referenda::types::DecidingStatus<BlockNumber>
   **/
  ...
  /**
   * Lookup792: pallet_referenda::types::TrackInfo<Balance, Moment>
   **/
  ...
  /**
   * Lookup793: pallet_referenda::types::Curve
   **/
  ...
  /**
   * Lookup796: pallet_referenda::pallet::Error<T, I>
   **/
  ...
  /**
   * Lookup797: pallet_remark::pallet::Error<T>
   **/
  PalletRemarkError: {
    _enum: ['Empty', 'BadContext']
  },
  /**
   * Lookup799: pallet_conviction_voting::vote::Voting<Balance, sp_core::crypto::AccountId32, BlockNumber, PollIndex, MaxVotes>
   **/
  ...
  /**
   * Lookup800: pallet_conviction_voting::vote::Casting<Balance, BlockNumber, PollIndex, MaxVotes>
   **/
  ...
  /**
   * Lookup804: pallet_conviction_voting::types::Delegations<Balance>
   **/
  ...
  /**
   * Lookup805: pallet_conviction_voting::vote::PriorLock<BlockNumber, Balance>
   **/
  PalletConvictionVotingVotePriorLock: '(u32,u128)',
  /**
   * Lookup806: pallet_conviction_voting::vote::Delegating<Balance, sp_core::crypto::AccountId32, BlockNumber>
   **/
  ...
  /**
   * Lookup810: pallet_conviction_voting::pallet::Error<T, I>
   **/
  ...
  /**
   * Lookup821: pallet_nomination_pools::PoolMember<T>
   **/
  ...
  /**
   * Lookup824: pallet_nomination_pools::BondedPoolInner<T>
   **/
  ...
  /**
   * Lookup825: pallet_nomination_pools::Commission<T>
   **/
  ...
  /**
   * Lookup828: pallet_nomination_pools::PoolRoles<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup829: pallet_nomination_pools::RewardPool<T>
   **/
  ...
  /**
   * Lookup830: pallet_nomination_pools::SubPools<T>
   **/
  ...
  /**
   * Lookup831: pallet_nomination_pools::UnbondPool<T>
   **/
  ...
  /**
   * Lookup836: pallet_nomination_pools::pallet::Error<T>
   **/
  ...
  /**
   * Lookup837: pallet_nomination_pools::pallet::DefensiveError
   **/
  PalletNominationPoolsDefensiveError: {
    _enum: ['NotEnoughSpaceInUnbondPool', 'PoolNotFound', 'RewardPoolNotFound', 'SubPoolsNotFound', 'BondedStashKilledPrematurely']
  },
  /**
   * Lookup838: pallet_referenda::types::ReferendumInfo<TrackId, kitchensink_runtime::OriginCaller, Moment, frame_support::traits::preimages::Bounded<kitchensink_runtime::RuntimeCall, sp_runtime::traits::BlakeTwo256>, Balance, pallet_ranked_collective::Tally<T, I, M>, sp_core::crypto::AccountId32, ScheduleAddress>
   **/
  ...
  /**
   * Lookup839: pallet_referenda::types::ReferendumStatus<TrackId, kitchensink_runtime::OriginCaller, Moment, frame_support::traits::preimages::Bounded<kitchensink_runtime::RuntimeCall, sp_runtime::traits::BlakeTwo256>, Balance, pallet_ranked_collective::Tally<T, I, M>, sp_core::crypto::AccountId32, ScheduleAddress>
   **/
  ...
  /**
   * Lookup842: pallet_ranked_collective::MemberRecord
   **/
  PalletRankedCollectiveMemberRecord: {
    rank: 'u16'
  },
  /**
   * Lookup846: pallet_ranked_collective::pallet::Error<T, I>
   **/
  ...
  /**
   * Lookup847: pallet_asset_conversion::types::PoolInfo<PoolAssetId>
   **/
  PalletAssetConversionPoolInfo: {
    lpToken: 'u32'
  },
  /**
   * Lookup848: pallet_asset_conversion::pallet::Error<T>
   **/
  ...
  /**
   * Lookup849: pallet_fast_unstake::types::UnstakeRequest<T>
   **/
  ...
  /**
   * Lookup855: pallet_message_queue::Neighbours<MessageOrigin>
   **/
  ...
  /**
   * Lookup856: pallet_message_queue::Page<Size, HeapSize>
   **/
  ...
  /**
   * Lookup858: pallet_message_queue::pallet::Error<T>
   **/
  ...
  /**
   * Lookup859: pallet_tx_pause::pallet::Error<T>
   **/
  PalletTxPauseError: {
    _enum: ['IsPaused', 'IsUnpaused', 'Unpausable', 'NotFound']
  },
  /**
   * Lookup860: pallet_safe_mode::pallet::Error<T>
   **/
  PalletSafeModeError: {
    _enum: ['Entered', 'Exited', 'NotConfigured', 'NoDeposit', 'AlreadyDeposited', 'CannotReleaseYet', 'CurrencyError']
  },
  /**
   * Lookup864: pallet_broker::types::LeaseRecordItem
   **/
  ...
  /**
   * Lookup866: pallet_broker::types::StatusRecord
   **/
  ...
  /**
   * Lookup867: pallet_broker::types::SaleInfoRecord<Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup868: pallet_broker::types::AllowedRenewalId
   **/
  ...
  /**
   * Lookup869: pallet_broker::types::AllowedRenewalRecord<Balance>
   **/
  ...
  /**
   * Lookup870: pallet_broker::types::CompletionStatus
   **/
  ...
  /**
   * Lookup871: pallet_broker::types::RegionRecord<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup873: pallet_broker::types::ContributionRecord<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup874: pallet_broker::types::PoolIoRecord
   **/
  ...
  /**
   * Lookup876: pallet_broker::types::InstaPoolHistoryRecord<Balance>
   **/
  ...
  /**
   * Lookup877: pallet_broker::pallet::Error<T>
   **/
  PalletBrokerError: {
  ...
  /**
   * Lookup878: pallet_example_tasks::pallet::Error<T>
   **/
  PalletExampleTasksError: {
    _enum: ['NotFound']
  },
  /**
   * Lookup881: frame_system::extensions::check_non_zero_sender::CheckNonZeroSender<T>
   **/
  ...
  /**
   * Lookup889: pallet_asset_conversion_tx_payment::ChargeAssetTxPayment<T>
   **/
