...
import type { BTreeMap, BitVec, Bytes, Compact, Enum, Null, Option, Result, Struct, U8aFixed, Vec, bool, u128, u16, u32, u64, u8 } from 'https://deno.land/x/polkadot@0.2.40/types-codec/mod.ts';
...
import type { AccountId32, H256, PerU16 } from 'https://deno.land/x/polkadot@0.2.40/types/interfaces/runtime/index.ts';
