...
import { transports } from 'https://deno.land/x/polkadot@0.2.19/hw-ledger-transports/mod.ts';
import { hexAddPrefix, u8aToBuffer } from 'https://deno.land/x/polkadot@0.2.19/util/mod.ts';
