...
import { transports } from 'https://deno.land/x/polkadot@0.2.23/hw-ledger-transports/mod.ts';
import { hexAddPrefix, u8aToBuffer } from 'https://deno.land/x/polkadot@0.2.23/util/mod.ts';
