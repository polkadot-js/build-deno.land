...
import { transports } from 'https://deno.land/x/polkadot@0.2.12/hw-ledger-transports/mod.ts';
import { u8aToBuffer } from 'https://deno.land/x/polkadot@0.2.12/util/mod.ts';
