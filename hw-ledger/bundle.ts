...
import { transports } from 'https://deno.land/x/polkadot@0.0.4-1/hw-ledger-transports/mod.ts';
import { u8aToBuffer } from 'https://deno.land/x/polkadot@0.0.4-1/util/mod.ts';
