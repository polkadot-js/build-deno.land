...
import { transports } from 'https://deno.land/x/polkadot@0.0.4-3/hw-ledger-transports/mod.ts';
import { u8aToBuffer } from 'https://deno.land/x/polkadot@0.0.4-3/util/mod.ts';
