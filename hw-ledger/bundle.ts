...
import { transports } from 'https://deno.land/x/polkadot@0.0.4-4/hw-ledger-transports/mod.ts';
import { u8aToBuffer } from 'https://deno.land/x/polkadot@0.0.4-4/util/mod.ts';
