...
import { transports } from 'https://deno.land/x/polkadot@0.2.8/hw-ledger-transports/mod.ts';
import { u8aToBuffer } from 'https://deno.land/x/polkadot@0.2.8/util/mod.ts';
