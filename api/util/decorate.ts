...
import type { ExactDerive } from 'https://deno.land/x/polkadot@0.0.0-8/api-derive/mod.ts';
import type { AnyFunction } from 'https://deno.land/x/polkadot@0.0.0-8/types/types.ts';
import type { ApiTypes, DecorateMethod, MethodResult } from '../types/index.ts';

import { lazyDeriveSection } from 'https://deno.land/x/polkadot@0.0.0-8/api-derive/mod.ts';
