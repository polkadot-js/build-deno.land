...
import type { ExactDerive } from 'https://deno.land/x/polkadot@0.2.2/api-derive/mod.ts';
...
import { lazyDeriveSection } from 'https://deno.land/x/polkadot@0.2.2/api-derive/mod.ts';
