...
import type { SiLookupTypeId } from 'https://deno.land/x/polkadot@0.2.3/types/interfaces/index.ts';
...
import { isUndefined } from 'https://deno.land/x/polkadot@0.2.3/util/mod.ts';
