...
import type { SiLookupTypeId } from 'https://deno.land/x/polkadot@0.2.18/types/interfaces/index.ts';
...
import { isUndefined } from 'https://deno.land/x/polkadot@0.2.18/util/mod.ts';
