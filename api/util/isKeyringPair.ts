...
import type { AccountId, Address } from 'https://deno.land/x/polkadot@0.0.7/types/interfaces/index.ts';
import type { IKeyringPair } from 'https://deno.land/x/polkadot@0.0.7/types/types/index.ts';
