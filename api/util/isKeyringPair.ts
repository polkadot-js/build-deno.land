...
import type { AccountId, Address } from 'https://deno.land/x/polkadot@0.2.16/types/interfaces/index.ts';
import type { IKeyringPair } from 'https://deno.land/x/polkadot@0.2.16/types/types/index.ts';
