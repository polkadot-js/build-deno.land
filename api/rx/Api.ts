 ...
 *
 * ```javascript
 * import ApiRx from 'https://deno.land/x/polkadot@0.2.12/api/rx/index.ts';
 *
 ...
 * import { ApiRx, WsProvider } from 'https://deno.land/x/polkadot@0.2.12/api/mod.ts';
 *
 *
 ...
 * import testingPairs from 'https://deno.land/x/polkadot@0.2.12/keyring/testingPairs.ts';
