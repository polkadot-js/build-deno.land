...
import { objectSpread } from 'https://deno.land/x/polkadot@0.2.16/util/mod.ts';
 ...
 *
 * ```javascript
 * import ApiRx from 'https://deno.land/x/polkadot@0.2.16/api/rx/index.ts';
 *
 ...
 * import { ApiRx, WsProvider } from 'https://deno.land/x/polkadot@0.2.16/api/mod.ts';
 *
 *
 ...
 * import testingPairs from 'https://deno.land/x/polkadot@0.2.16/keyring/testingPairs.ts';
