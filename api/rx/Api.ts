 ...
 *
 * ```javascript
 * import ApiRx from 'https://deno.land/x/polkadot@0.0.4-4/api/rx/index.ts';
 *
 ...
 * import { ApiRx, WsProvider } from 'https://deno.land/x/polkadot@0.0.4-4/api/mod.ts';
 *
 *
 ...
 * import testingPairs from 'https://deno.land/x/polkadot@0.0.4-4/keyring/testingPairs.ts';
...
export class ApiRx extends ApiBase<'rxjs'> {
   ...
   * import Api from 'https://deno.land/x/polkadot@0.0.4-4/api/rx/index.ts';
   *
   * new Api().isReady
   *   .pipe(
   *     switchMap((api) =>
