...
import { objectSpread } from 'https://deno.land/x/polkadot@0.2.18/util/mod.ts';
 ...
 *
 * ```javascript
 * import ApiRx from 'https://deno.land/x/polkadot@0.2.18/api/rx/index.ts';
 *
 ...
 * import { ApiRx, WsProvider } from 'https://deno.land/x/polkadot@0.2.18/api/mod.ts';
 *
 *
 ...
 * import testingPairs from 'https://deno.land/x/polkadot@0.2.18/keyring/testingPairs.ts';
...
export class ApiRx extends ApiBase<'rxjs'> {
   ...
   * import Api from 'https://deno.land/x/polkadot@0.2.18/api/rx/index.ts';
   *
   * new Api().isReady
   *   .pipe(
   *     switchMap((api) =>
