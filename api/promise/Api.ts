 ...
 *
 * ```javascript
 * import ApiPromise from 'https://deno.land/x/polkadot@0.2.0/api/promise/index.ts';
 *
 ...
 *
 * ```javascript
 * import { ApiPromise, WsProvider } from 'https://deno.land/x/polkadot@0.2.0/api/mod.ts';
 *
