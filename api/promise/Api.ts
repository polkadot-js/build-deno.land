 ...
 *
 * ```javascript
 * import ApiPromise from 'https://deno.land/x/polkadot@0.0.0-5/api/promise.ts';
 *
 ...
 *
 * ```javascript
 * import { ApiPromise, WsProvider } from 'https://deno.land/x/polkadot@0.0.0-5/api/mod.ts';
 *
