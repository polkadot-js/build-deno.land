...
import { noop, objectSpread } from 'https://deno.land/x/polkadot@0.2.43/util/mod.ts';
 ...
 *
 * ```javascript
 * import ApiPromise from 'https://deno.land/x/polkadot@0.2.43/api/promise/index.ts';
 *
