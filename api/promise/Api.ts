 ...
 *
 * ```javascript
 * import ApiPromise from 'https://deno.land/x/polkadot@0.2.10/api/promise/index.ts';
 *
 ...
 *
 * ```javascript
 * import { ApiPromise, WsProvider } from 'https://deno.land/x/polkadot@0.2.10/api/mod.ts';
 *
