 ...
 *
 * ```javascript
 * import ApiPromise from 'https://deno.land/x/polkadot@0.2.4/api/promise/index.ts';
 *
 ...
 *
 * ```javascript
 * import { ApiPromise, WsProvider } from 'https://deno.land/x/polkadot@0.2.4/api/mod.ts';
 *
