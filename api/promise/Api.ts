 ...
 *
 * ```javascript
 * import ApiPromise from 'https://deno.land/x/polkadot@0.0.4-7/api/promise/index.ts';
 *
 ...
 *
 * ```javascript
 * import { ApiPromise, WsProvider } from 'https://deno.land/x/polkadot@0.0.4-7/api/mod.ts';
 *
