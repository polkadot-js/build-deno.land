...
import type { Callback, Codec } from 'https://deno.land/x/polkadot@0.2.1/types/types/index.ts';
...
import { isFunction, nextTick } from 'https://deno.land/x/polkadot@0.2.1/util/mod.ts';
