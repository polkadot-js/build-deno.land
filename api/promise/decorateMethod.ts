...
import type { Callback, Codec } from 'https://deno.land/x/polkadot@0.0.9/types/types/index.ts';
...
import { isFunction, nextTick } from 'https://deno.land/x/polkadot@0.0.9/util/mod.ts';
