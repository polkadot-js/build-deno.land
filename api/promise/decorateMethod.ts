...
import type { Callback, Codec } from 'https://deno.land/x/polkadot@0.1.0/types/types/index.ts';
...
import { isFunction, nextTick } from 'https://deno.land/x/polkadot@0.1.0/util/mod.ts';
