...
import type { Callback, Codec } from 'https://deno.land/x/polkadot@0.0.8/types/types/index.ts';
...
import { isFunction, nextTick } from 'https://deno.land/x/polkadot@0.0.8/util/mod.ts';
