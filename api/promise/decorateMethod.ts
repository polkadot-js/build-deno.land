...
import type { Callback, Codec } from 'https://deno.land/x/polkadot@0.0.5/types/types/index.ts';
...
import { assert, isFunction, nextTick } from 'https://deno.land/x/polkadot@0.0.5/util/mod.ts';
