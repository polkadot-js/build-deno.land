...
import type { Callback, Codec } from 'https://deno.land/x/polkadot@0.0.0-7/types/types.ts';
...
import { assert, isFunction, nextTick } from 'https://deno.land/x/polkadot@0.0.0-7/util/mod.ts';
