...
import type { Callback, Codec } from 'https://deno.land/x/polkadot@0.0.0-6/types/types.ts';
...
import { assert, isFunction, nextTick } from 'https://deno.land/x/polkadot@0.0.0-6/util/mod.ts';
