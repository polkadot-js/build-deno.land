...
import type { Callback, Codec } from 'https://deno.land/x/polkadot@0.0.0-8/types/types.ts';
...
import { assert, isFunction, nextTick } from 'https://deno.land/x/polkadot@0.0.0-8/util/mod.ts';
