...
import type { Callback, Codec } from 'https://deno.land/x/polkadot@0.2.44/types/types/index.ts';
...
import { isFunction, nextTick } from 'https://deno.land/x/polkadot@0.2.44/util/mod.ts';
