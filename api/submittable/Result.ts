...
import type { DispatchError, DispatchInfo, EventRecord, ExtrinsicStatus, Hash } from 'https://deno.land/x/polkadot@0.0.0-6/types/interfaces.ts';
import type { AnyJson, ISubmittableResult } from 'https://deno.land/x/polkadot@0.0.0-6/types/types.ts';
