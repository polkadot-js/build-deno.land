...
import type { Observable, Subscription } from 'https://cdn.skypack.dev/rxjs@7.5.5';
...
import type { ChainProperties, Hash, HeaderPartial, RuntimeVersion, RuntimeVersionPartial } from 'https://deno.land/x/polkadot/types/interfaces.ts';
...
import { firstValueFrom, map, of, switchMap } from 'https://cdn.skypack.dev/rxjs@7.5.5';
