...
import type { RpcCoreStats, RpcInterface } from 'https://deno.land/x/polkadot@0.2.44/rpc-core/types/index.ts';
...
import type { Metadata } from 'https://deno.land/x/polkadot@0.2.44/types/metadata/index.ts';
import type { CallFunction, RegistryError } from 'https://deno.land/x/polkadot@0.2.44/types/types/index.ts';
