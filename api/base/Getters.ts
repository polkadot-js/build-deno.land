...
import type { ProviderInterface } from 'https://deno.land/x/polkadot@0.2.26/rpc-provider/types.ts';
import type { Text } from 'https://deno.land/x/polkadot@0.2.26/types/mod.ts';
import type { Hash, RuntimeVersion } from 'https://deno.land/x/polkadot@0.2.26/types/interfaces/index.ts';
import type { Metadata } from 'https://deno.land/x/polkadot@0.2.26/types/metadata/index.ts';
import type { CallFunction, RegistryError } from 'https://deno.land/x/polkadot@0.2.26/types/types/index.ts';
