...
import type { RpcCoreStats, RpcInterface } from 'https://deno.land/x/polkadot@0.2.45/rpc-core/types/index.ts';
...
import type { Metadata } from 'https://deno.land/x/polkadot@0.2.45/types/metadata/index.ts';
import type { CallFunction, RegistryError } from 'https://deno.land/x/polkadot@0.2.45/types/types/index.ts';
