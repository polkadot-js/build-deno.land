...
import type { Metadata } from 'https://deno.land/x/polkadot@0.2.21/types/metadata/index.ts';
import type { CallFunction, RegistryError } from 'https://deno.land/x/polkadot@0.2.21/types/types/index.ts';
