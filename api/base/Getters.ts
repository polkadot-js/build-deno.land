...
import type { ProviderInterface } from 'https://deno.land/x/polkadot@0.2.9/rpc-provider/types.ts';
...
import type { Metadata } from 'https://deno.land/x/polkadot@0.2.9/types/metadata/index.ts';
import type { CallFunction, RegistryError } from 'https://deno.land/x/polkadot@0.2.9/types/types/index.ts';
