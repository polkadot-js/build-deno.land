...
import type { ProviderInterface } from 'https://deno.land/x/polkadot@0.2.15/rpc-provider/types.ts';
import type { Text } from 'https://deno.land/x/polkadot@0.2.15/types/mod.ts';
import type { Hash, RuntimeVersion } from 'https://deno.land/x/polkadot@0.2.15/types/interfaces/index.ts';
import type { Metadata } from 'https://deno.land/x/polkadot@0.2.15/types/metadata/index.ts';
import type { CallFunction, RegistryError } from 'https://deno.land/x/polkadot@0.2.15/types/types/index.ts';
