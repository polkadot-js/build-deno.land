...
import type { ProviderInterface } from 'https://deno.land/x/polkadot@0.2.10/rpc-provider/types.ts';
import type { Text } from 'https://deno.land/x/polkadot@0.2.10/types/mod.ts';
import type { Hash, RuntimeVersion } from 'https://deno.land/x/polkadot@0.2.10/types/interfaces/index.ts';
import type { Metadata } from 'https://deno.land/x/polkadot@0.2.10/types/metadata/index.ts';
import type { CallFunction, RegistryError } from 'https://deno.land/x/polkadot@0.2.10/types/types/index.ts';
