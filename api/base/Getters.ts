...
import type { ProviderInterface } from 'https://deno.land/x/polkadot@0.2.0/rpc-provider/types.ts';
...
import type { Metadata } from 'https://deno.land/x/polkadot@0.2.0/types/metadata/index.ts';
import type { CallFunction, RegistryError } from 'https://deno.land/x/polkadot@0.2.0/types/types/index.ts';
