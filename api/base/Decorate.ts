...
import type { AugmentedCall, DeriveCustom, QueryableCalls } from 'https://deno.land/x/polkadot@0.2.5/api-base/types/index.ts';
import type { RpcInterface } from 'https://deno.land/x/polkadot@0.2.5/rpc-core/types/index.ts';
import type { StorageKey, Text, u64 } from 'https://deno.land/x/polkadot@0.2.5/types/mod.ts';
import type { Call, Hash, RuntimeVersion } from 'https://deno.land/x/polkadot@0.2.5/types/interfaces/index.ts';
import type { DecoratedMeta } from 'https://deno.land/x/polkadot@0.2.5/types/metadata/decorate/types.ts';
import type { StorageEntry } from 'https://deno.land/x/polkadot@0.2.5/types/primitive/types.ts';
import type { AnyFunction, AnyTuple, CallFunction, Codec, DefinitionCallNamed, DefinitionRpc, DefinitionRpcSub, DefinitionsCall, DefinitionsCallEntry, DetectCodec, IMethod, IStorageKey, Registry, RegistryError, RegistryTypes } from 'https://deno.land/x/polkadot@0.2.5/types/types/index.ts';
...
import { getAvailableDerives } from 'https://deno.land/x/polkadot@0.2.5/api-derive/mod.ts';
import { memo, RpcCore } from 'https://deno.land/x/polkadot@0.2.5/rpc-core/mod.ts';
import { WsProvider } from 'https://deno.land/x/polkadot@0.2.5/rpc-provider/mod.ts';
import { expandMetadata, GenericExtrinsic, Metadata, typeDefinitions, TypeRegistry } from 'https://deno.land/x/polkadot@0.2.5/types/mod.ts';
import { getSpecRuntime } from 'https://deno.land/x/polkadot@0.2.5/types-known/mod.ts';
import { arrayChunk, arrayFlatten, assertReturn, BN, compactStripLength, lazyMethod, lazyMethods, logger, nextTick, objectSpread, stringCamelCase, stringUpperFirst, u8aConcatStrict, u8aToHex } from 'https://deno.land/x/polkadot@0.2.5/util/mod.ts';
import { blake2AsHex } from 'https://deno.land/x/polkadot@0.2.5/util-crypto/mod.ts';
...
export abstract class Decorate<ApiType extends ApiTypes> extends Events {
   ...
   *
   * ```javascript
   * import Api from 'https://deno.land/x/polkadot@0.2.5/api/promise/index.ts';
   *
