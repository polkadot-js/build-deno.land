...
import type { CallFunction, Registry, RegistryError } from 'https://deno.land/x/polkadot@0.0.4-7/types/types/index.ts';

import { u8aToU8a } from 'https://deno.land/x/polkadot@0.0.4-7/util/mod.ts';
