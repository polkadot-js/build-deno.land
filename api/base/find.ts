...
import type { CallFunction, Registry, RegistryError } from 'https://deno.land/x/polkadot@0.0.0-6/types/types.ts';

import { u8aToU8a } from 'https://deno.land/x/polkadot@0.0.0-6/util/mod.ts';
