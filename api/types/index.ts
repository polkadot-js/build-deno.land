...
import type { CallFunction, DefinitionRpc, DefinitionRpcSub, RegisteredTypes, Registry, RegistryError, SignatureOptions, Signer } from 'https://deno.land/x/polkadot/types/types/index.ts';
...
export { Signer, SignerResult } from 'https://deno.land/x/polkadot/types/types/index.ts';
