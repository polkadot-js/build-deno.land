...
import type { Signer, SignerResult } from 'https://deno.land/x/polkadot@0.2.6/api/types/index.ts';
import type { KeyringPair } from 'https://deno.land/x/polkadot@0.2.6/keyring/types.ts';
import type { Registry, SignerPayloadJSON, SignerPayloadRaw } from 'https://deno.land/x/polkadot@0.2.6/types/types/index.ts';

import { hexToU8a, objectSpread, u8aToHex } from 'https://deno.land/x/polkadot@0.2.6/util/mod.ts';
