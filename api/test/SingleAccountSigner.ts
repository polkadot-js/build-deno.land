...
import type { Signer, SignerResult } from 'https://deno.land/x/polkadot@0.0.7/api/types/index.ts';
import type { KeyringPair } from 'https://deno.land/x/polkadot@0.0.7/keyring/types.ts';
import type { Registry, SignerPayloadJSON, SignerPayloadRaw } from 'https://deno.land/x/polkadot@0.0.7/types/types/index.ts';

import { hexToU8a, u8aToHex } from 'https://deno.land/x/polkadot@0.0.7/util/mod.ts';
