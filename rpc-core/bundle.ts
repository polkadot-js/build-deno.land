...
import type { AnyJson, AnyNumber, Codec, DefinitionRpc, DefinitionRpcExt, DefinitionRpcSub, Registry } from 'https://deno.land/x/polkadot/types/types.ts';
 ...
 * import { WsProvider } from 'https://deno.land/x/polkadot/rpc-provider/ws.ts';
 *
