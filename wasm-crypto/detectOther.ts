...
import { packageInfo as initInfo } from 'https://deno.land/x/polkadot@0.2.29/wasm-crypto-init/packageInfo.ts';
import { packageInfo as wasmInfo } from 'https://deno.land/x/polkadot@0.2.29/wasm-crypto-wasm/packageInfo.ts';
import { packageInfo as utilInfo } from 'https://deno.land/x/polkadot@0.2.29/wasm-util/packageInfo.ts';
