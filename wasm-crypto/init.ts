...
import { Bridge } from 'https://deno.land/x/polkadot@0.2.40/wasm-bridge/mod.ts';
import { createWasm } from 'https://deno.land/x/polkadot@0.2.40/wasm-crypto-init/mod.ts';
