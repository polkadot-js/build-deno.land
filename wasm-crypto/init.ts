...
import { Bridge } from 'https://deno.land/x/polkadot@0.2.35/wasm-bridge/mod.ts';
import { createWasm } from 'https://deno.land/x/polkadot@0.2.35/wasm-crypto-init/mod.ts';
