...
import { Bridge } from 'https://deno.land/x/polkadot@0.2.34/wasm-bridge/mod.ts';
import { createWasm } from 'https://deno.land/x/polkadot@0.2.34/wasm-crypto-init/mod.ts';
