...
import type { BTreeMap, BTreeSet, Bytes, Null, Option, Struct, U8aFixed, Vec, bool, u128, u16, u32, u64, u8 } from 'https://deno.land/x/polkadot/types-codec/mod.ts';
...
declare module 'https://deno.land/x/polkadot/api-base/types/storage.ts' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    multiBlockElectionSigned: {
       ...
       **/
      submissionStorage: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: AccountId32 | string | Uint8Array, arg3: u32 | AnyNumber | Uint8Array) => Observable<Option<AssetHubPolkadotRuntimeStakingNposCompactSolution16>>, [u32, AccountId32, u32]> & QueryableStorageEntry<ApiType, [u32, AccountId32, u32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    parameters: {
       ...
       * Stored parameters.
       **/
      parameters: AugmentedQuery<ApiType, (arg: AssetHubPolkadotRuntimeRuntimeParametersKey | { StakingElection: any } | { Scheduler: any } | { MessageQueue: any } | string | Uint8Array) => Observable<Option<AssetHubPolkadotRuntimeRuntimeParametersValue>>, [AssetHubPolkadotRuntimeRuntimeParametersKey]> & QueryableStorageEntry<ApiType, [AssetHubPolkadotRuntimeRuntimeParametersKey]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    snowbridgeSystemFrontend: {
       ...
       **/
      exportOperatingMode: AugmentedQuery<ApiType, () => Observable<SnowbridgeCoreOperatingModeBasicOperatingMode>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
