...
import 'https://deno.land/x/polkadot@0.2.15/api-base/types/storage.ts';

import type { ApiTypes, AugmentedQuery, QueryableStorageEntry } from 'https://deno.land/x/polkadot@0.2.15/api-base/types/index.ts';
import type { Data } from 'https://deno.land/x/polkadot@0.2.15/types/mod.ts';
import type { Bytes, Null, Option, U8aFixed, Vec, WrapperOpaque, bool, u128, u16, u32, u64 } from 'https://deno.land/x/polkadot@0.2.15/types-codec/mod.ts';
import type { AnyNumber, ITuple } from 'https://deno.land/x/polkadot@0.2.15/types-codec/types/index.ts';
import type { EthereumAddress } from 'https://deno.land/x/polkadot@0.2.15/types/interfaces/eth/index.ts';
import type { AccountId32, Call, H256, Perbill, Percent } from 'https://deno.land/x/polkadot@0.2.15/types/interfaces/runtime/index.ts';
...
import type { Observable } from 'https://deno.land/x/polkadot@0.2.15/types/types/index.ts';

export type __AugmentedQuery<ApiType extends ApiTypes> = AugmentedQuery<ApiType, () => unknown>;
export type __QueryableStorageEntry<ApiType extends ApiTypes> = QueryableStorageEntry<ApiType>;

declare module 'https://deno.land/x/polkadot@0.2.15/api-base/types/storage.ts' {
