...
import type { Bytes, Option, Vec, u128, u16, u32, u64, u8 } from 'https://deno.land/x/polkadot@0.2.43/types-codec/mod.ts';
import type { Codec, ITuple } from 'https://deno.land/x/polkadot@0.2.43/types-codec/types/index.ts';
import type { Perbill, Permill, Perquintill } from 'https://deno.land/x/polkadot@0.2.43/types/interfaces/runtime/index.ts';
import type { FrameSupportPalletId, FrameSystemLimitsBlockLength, FrameSystemLimitsBlockWeights, PalletReferendaTrackInfo, SpVersionRuntimeVersion, SpWeightsRuntimeDbWeight, SpWeightsWeightV2Weight } from 'https://deno.land/x/polkadot@0.2.43/types/lookup.ts';
