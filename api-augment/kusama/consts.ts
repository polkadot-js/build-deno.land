...
import type { Bytes, Option, U8aFixed, Vec, bool, u128, u16, u32, u64, u8 } from 'https://deno.land/x/polkadot@0.2.11/types-codec/mod.ts';
import type { Codec } from 'https://deno.land/x/polkadot@0.2.11/types-codec/types/index.ts';
import type { Perbill, Percent, Permill, Weight } from 'https://deno.land/x/polkadot@0.2.11/types/interfaces/runtime/index.ts';
import type { FrameSupportPalletId, FrameSystemLimitsBlockLength, FrameSystemLimitsBlockWeights, SpVersionRuntimeVersion, SpWeightsRuntimeDbWeight } from 'https://deno.land/x/polkadot@0.2.11/types/lookup.ts';
