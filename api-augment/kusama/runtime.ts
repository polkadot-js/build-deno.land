...
import type { Bytes, Null, Option, Result, Vec, bool, u32 } from 'https://deno.land/x/polkadot@0.2.39/types-codec/mod.ts';
...
import type { BeefyEquivocationProof, ValidatorSet, ValidatorSetId } from 'https://deno.land/x/polkadot@0.2.39/types/interfaces/beefy/index.ts';
