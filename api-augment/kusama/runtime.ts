...
import type { Bytes, Null, Option, Result, Vec, bool, u32 } from 'https://deno.land/x/polkadot@0.2.7/types-codec/mod.ts';
...
import type { ValidatorSet } from 'https://deno.land/x/polkadot@0.2.7/types/interfaces/beefy/index.ts';
