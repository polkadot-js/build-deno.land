...
import type { Bytes, Null, Option, Result, Vec, bool, u32 } from 'https://deno.land/x/polkadot@0.2.44/types-codec/mod.ts';
...
import type { BeefyAuthoritySet, BeefyEquivocationProof, BeefyNextAuthoritySet, ValidatorSet, ValidatorSetId } from 'https://deno.land/x/polkadot@0.2.44/types/interfaces/beefy/index.ts';
