...
import type { Bytes, Null, Option, Result, Vec, bool, u32 } from 'https://deno.land/x/polkadot@0.0.3/types-codec/mod.ts';
...
import type { ValidatorSet } from 'https://deno.land/x/polkadot@0.0.3/types/interfaces/beefy/index.ts';
...
import type { AccountId, Block, Hash, Header, Index, KeyTypeId, Slot, ValidatorId } from 'https://deno.land/x/polkadot@0.0.3/types/interfaces/runtime/index.ts';
