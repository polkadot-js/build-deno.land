...
import type { Bytes, Null, Option, Result, Vec, u32 } from 'https://deno.land/x/polkadot@0.2.28/types-codec/mod.ts';
...
import type { CodeSource, CodeUploadResult, ContractExecResult, ContractInstantiateResult } from 'https://deno.land/x/polkadot@0.2.28/types/interfaces/contracts/index.ts';
...
import type { AccountId, Balance, Block, Call, Hash, Header, Index, KeyTypeId, Slot, Weight, WeightV2 } from 'https://deno.land/x/polkadot@0.2.28/types/interfaces/runtime/index.ts';
