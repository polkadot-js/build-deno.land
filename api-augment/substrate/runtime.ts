...
import type { Bytes, Null, Option, Result, Vec, u32, u64 } from 'https://deno.land/x/polkadot@0.0.4-9/types-codec/mod.ts';
...
import type { CodeUploadResult, ContractExecResult, ContractInstantiateResult } from 'https://deno.land/x/polkadot@0.0.4-9/types/interfaces/contracts/index.ts';
...
import type { AccountId, Balance, Block, Hash, Header, Index, KeyTypeId, Slot } from 'https://deno.land/x/polkadot@0.0.4-9/types/interfaces/runtime/index.ts';
