...
import type { BTreeMap, Bytes, Null, Option, U8aFixed, Vec, WrapperKeepOpaque, WrapperOpaque, bool, u128, u16, u32, u64, u8 } from 'https://deno.land/x/polkadot/types-codec/mod.ts';
import type { AnyNumber, ITuple } from 'https://deno.land/x/polkadot/types-codec/types.ts';
import type { AccountId32, Call, H256, Perbill, Percent } from 'https://deno.land/x/polkadot/types/interfaces/runtime.ts';
...
import type { Observable } from 'https://deno.land/x/polkadot/types/types.ts';
