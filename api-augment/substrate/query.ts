...
import type { BTreeMap, Bytes, Null, Option, U8aFixed, Vec, WrapperKeepOpaque, WrapperOpaque, bool, u128, u16, u32, u64, u8 } from 'https://deno.land/x/polkadot@0.0.0-7/types-codec/mod.ts';
import type { AnyNumber, ITuple } from 'https://deno.land/x/polkadot@0.0.0-7/types-codec/types.ts';
import type { AccountId32, Call, H256, Perbill, Percent } from 'https://deno.land/x/polkadot@0.0.0-7/types/interfaces/runtime.ts';
...
import type { Observable } from 'https://deno.land/x/polkadot@0.0.0-7/types/types.ts';
