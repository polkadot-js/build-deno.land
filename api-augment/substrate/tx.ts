...
import type { AnyNumber, IMethod, ITuple } from 'https://deno.land/x/polkadot/types-codec/types.ts';
import type { AccountId32, Call, H256, MultiAddress, Perbill, Percent, Perquintill } from 'https://deno.land/x/polkadot/types/interfaces/runtime.ts';
