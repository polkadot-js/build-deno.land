...
import 'https://deno.land/x/polkadot@0.0.6/api-base/types/consts.ts';

import type { ApiTypes, AugmentedConst } from 'https://deno.land/x/polkadot@0.0.6/api-base/types/index.ts';
import type { Option, U8aFixed, Vec, bool, u128, u16, u32, u64, u8 } from 'https://deno.land/x/polkadot@0.0.6/types-codec/mod.ts';
import type { Codec } from 'https://deno.land/x/polkadot@0.0.6/types-codec/types/index.ts';
import type { Perbill, Percent, Permill } from 'https://deno.land/x/polkadot@0.0.6/types/interfaces/runtime/index.ts';
import type { FrameSupportPalletId, FrameSupportWeightsRuntimeDbWeight, FrameSystemLimitsBlockLength, FrameSystemLimitsBlockWeights, PalletContractsSchedule, SpVersionRuntimeVersion } from 'https://deno.land/x/polkadot@0.0.6/types/lookup.ts';

export type __AugmentedConst<ApiType extends ApiTypes> = AugmentedConst<ApiType>;

declare module 'https://deno.land/x/polkadot@0.0.6/api-base/types/consts.ts' {
