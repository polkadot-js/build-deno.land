...
import 'https://deno.land/x/polkadot@0.2.32/api-base/types/errors.ts';

import type { ApiTypes, AugmentedError } from 'https://deno.land/x/polkadot@0.2.32/api-base/types/index.ts';

export type __AugmentedError<ApiType extends ApiTypes> = AugmentedError<ApiType>;

declare module 'https://deno.land/x/polkadot@0.2.32/api-base/types/errors.ts' {
