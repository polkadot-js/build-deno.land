...
import 'https://deno.land/x/polkadot@0.2.20/api-base/types/calls.ts';

import type { ApiTypes, AugmentedCall, DecoratedCallBase } from 'https://deno.land/x/polkadot@0.2.20/api-base/types/index.ts';
import type { Bytes, Null, Option, Result, Vec, bool, u32 } from 'https://deno.land/x/polkadot@0.2.20/types-codec/mod.ts';
import type { AnyNumber, IMethod, ITuple } from 'https://deno.land/x/polkadot@0.2.20/types-codec/types/index.ts';
import type { BabeEquivocationProof, BabeGenesisConfiguration, Epoch, OpaqueKeyOwnershipProof } from 'https://deno.land/x/polkadot@0.2.20/types/interfaces/babe/index.ts';
import type { ValidatorSet } from 'https://deno.land/x/polkadot@0.2.20/types/interfaces/beefy/index.ts';
import type { CheckInherentsResult, InherentData } from 'https://deno.land/x/polkadot@0.2.20/types/interfaces/blockbuilder/index.ts';
...
import type { AuthorityList, GrandpaEquivocationProof, SetId } from 'https://deno.land/x/polkadot@0.2.20/types/interfaces/grandpa/index.ts';
import type { OpaqueMetadata } from 'https://deno.land/x/polkadot@0.2.20/types/interfaces/metadata/index.ts';
import type { MmrBatchProof, MmrEncodableOpaqueLeaf, MmrError, MmrLeafIndex, MmrProof } from 'https://deno.land/x/polkadot@0.2.20/types/interfaces/mmr/index.ts';
import type { CandidateCommitments, CandidateEvent, CommittedCandidateReceipt, CoreState, GroupRotationInfo, InboundDownwardMessage, InboundHrmpMessage, OccupiedCoreAssumption, ParaId, ParaValidatorIndex, PersistedValidationData, PvfCheckStatement, ScrapedOnChainVotes, SessionInfo, ValidationCode, ValidationCodeHash, ValidatorSignature } from 'https://deno.land/x/polkadot@0.2.20/types/interfaces/parachains/index.ts';
import type { FeeDetails, RuntimeDispatchInfo } from 'https://deno.land/x/polkadot@0.2.20/types/interfaces/payment/index.ts';
import type { AccountId, Balance, Block, Call, Hash, Header, Index, KeyTypeId, Slot, ValidatorId } from 'https://deno.land/x/polkadot@0.2.20/types/interfaces/runtime/index.ts';
import type { SessionIndex } from 'https://deno.land/x/polkadot@0.2.20/types/interfaces/session/index.ts';
import type { RuntimeVersion } from 'https://deno.land/x/polkadot@0.2.20/types/interfaces/state/index.ts';
import type { ApplyExtrinsicResult } from 'https://deno.land/x/polkadot@0.2.20/types/interfaces/system/index.ts';
import type { TransactionSource, TransactionValidity } from 'https://deno.land/x/polkadot@0.2.20/types/interfaces/txqueue/index.ts';
...
declare module 'https://deno.land/x/polkadot@0.2.20/api-base/types/calls.ts' {
