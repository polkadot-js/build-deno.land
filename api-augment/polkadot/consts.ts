...
import type { Codec } from 'https://deno.land/x/polkadot@0.2.21/types-codec/types/index.ts';
import type { Perbill, Percent, Permill } from 'https://deno.land/x/polkadot@0.2.21/types/interfaces/runtime/index.ts';
import type { FrameSupportPalletId, FrameSystemLimitsBlockLength, FrameSystemLimitsBlockWeights, SpVersionRuntimeVersion, SpWeightsRuntimeDbWeight, SpWeightsWeightV2Weight } from 'https://deno.land/x/polkadot@0.2.21/types/lookup.ts';
