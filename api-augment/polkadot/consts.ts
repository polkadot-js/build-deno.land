...
import type { Bytes, Option, U8aFixed, Vec, bool, u128, u16, u32, u64, u8 } from 'https://deno.land/x/polkadot@0.2.37/types-codec/mod.ts';
import type { Codec, ITuple } from 'https://deno.land/x/polkadot@0.2.37/types-codec/types/index.ts';
import type { Perbill, Percent, Permill } from 'https://deno.land/x/polkadot@0.2.37/types/interfaces/runtime/index.ts';
import type { FrameSupportPalletId, FrameSystemLimitsBlockLength, FrameSystemLimitsBlockWeights, PalletReferendaTrackInfo, SpVersionRuntimeVersion, SpWeightsRuntimeDbWeight, SpWeightsWeightV2Weight } from 'https://deno.land/x/polkadot@0.2.37/types/lookup.ts';
