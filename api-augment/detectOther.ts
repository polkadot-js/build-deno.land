...
import { packageInfo as baseInfo } from 'https://deno.land/x/polkadot@0.0.3/api-base/packageInfo.ts';
import { packageInfo as typesInfo } from 'https://deno.land/x/polkadot@0.0.3/types/packageInfo.ts';
import { packageInfo as codecInfo } from 'https://deno.land/x/polkadot@0.0.3/types-codec/packageInfo.ts';
