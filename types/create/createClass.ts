...
import type { Codec, CodecClass, Registry } from 'https://deno.land/x/polkadot@0.0.0-8/types-codec/types.ts';
import type { DetectCodec } from '../types/index.ts';

import { createClassUnsafe } from 'https://deno.land/x/polkadot@0.0.0-8/types-create/mod.ts';
