...
import type { Codec, Registry } from 'https://deno.land/x/polkadot@0.0.0-7/types-codec/types.ts';
import type { DetectCodec } from '../types/index.ts';

import { createTypeUnsafe } from 'https://deno.land/x/polkadot@0.0.0-7/types-create/mod.ts';
