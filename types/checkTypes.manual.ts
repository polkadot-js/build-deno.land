...
import 'https://deno.land/x/polkadot@0.0.4-1/types-augment/mod.ts';

import type { Bytes, Compact, Option, u32 } from 'https://deno.land/x/polkadot@0.0.4-1/types-codec/mod.ts';
import type { IOption, ITuple } from 'https://deno.land/x/polkadot@0.0.4-1/types-codec/types/index.ts';
import type { AccountId, BlockAttestations, SessionKeys7 } from './interfaces/index.ts';

import { assert } from 'https://deno.land/x/polkadot@0.0.4-1/util/mod.ts';
