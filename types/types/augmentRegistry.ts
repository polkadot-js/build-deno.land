...
import 'https://deno.land/x/polkadot@0.0.4-2/types-create/types/augmentRegistry.ts';

import type { Codec, CodecClass } from 'https://deno.land/x/polkadot@0.0.4-2/types-codec/types/index.ts';
