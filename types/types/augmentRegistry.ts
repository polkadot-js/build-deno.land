...
import 'https://deno.land/x/polkadot@0.0.4-1/types-create/types/augmentRegistry.ts';

import type { Codec, CodecClass } from 'https://deno.land/x/polkadot@0.0.4-1/types-codec/types/index.ts';
