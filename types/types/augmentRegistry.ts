...
import 'https://deno.land/x/polkadot@0.2.42/types-codec/types/registry.ts';
import 'https://deno.land/x/polkadot@0.2.42/types-create/types/augmentRegistry.ts';

import type { AnyString, Codec, CodecClass, LookupString } from 'https://deno.land/x/polkadot@0.2.42/types-codec/types/index.ts';
...
declare module 'https://deno.land/x/polkadot@0.2.42/types-codec/types/registry.ts' {
