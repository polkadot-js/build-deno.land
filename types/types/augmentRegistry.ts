...
import 'https://deno.land/x/polkadot@0.2.28/types-create/types/augmentRegistry.ts';

import type { AnyString, Codec, CodecClass, LookupString } from 'https://deno.land/x/polkadot@0.2.28/types-codec/types/index.ts';
