...
import 'https://deno.land/x/polkadot@0.2.30/types-codec/types/registry.ts';
import 'https://deno.land/x/polkadot@0.2.30/types-create/types/augmentRegistry.ts';

import type { AnyString, Codec, CodecClass, LookupString } from 'https://deno.land/x/polkadot@0.2.30/types-codec/types/index.ts';
import type { TypeDef } from 'https://deno.land/x/polkadot@0.2.30/types-create/types/index.ts';
...
declare module 'https://deno.land/x/polkadot@0.2.30/types-codec/types/registry.ts' {
