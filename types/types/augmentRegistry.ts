...
import 'https://deno.land/x/polkadot@0.2.35/types-create/types/augmentRegistry.ts';

import type { AnyString, Codec, CodecClass, LookupString } from 'https://deno.land/x/polkadot@0.2.35/types-codec/types/index.ts';
