...
import 'https://deno.land/x/polkadot@0.2.39/types-create/types/augmentRegistry.ts';

import type { AnyString, Codec, CodecClass, LookupString } from 'https://deno.land/x/polkadot@0.2.39/types-codec/types/index.ts';
