...
import 'https://deno.land/x/polkadot@0.0.0-8/types-create/types/augmentRegistry.ts';

import type { Codec, CodecClass } from 'https://deno.land/x/polkadot@0.0.0-8/types-codec/types.ts';
