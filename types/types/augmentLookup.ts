...
import 'https://deno.land/x/polkadot@0.2.11/types-create/types/lookup.ts';

import type { Vec } from 'https://deno.land/x/polkadot@0.2.11/types-codec/mod.ts';
...
declare module 'https://deno.land/x/polkadot@0.2.11/types-create/types/lookup.ts' {
  interface ILookup {
