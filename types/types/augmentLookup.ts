...
import 'https://deno.land/x/polkadot@0.2.45/types-create/types/lookup.ts';

import type { Vec } from 'https://deno.land/x/polkadot@0.2.45/types-codec/mod.ts';
import type { LookupString } from 'https://deno.land/x/polkadot@0.2.45/types-codec/types/index.ts';
...
declare module 'https://deno.land/x/polkadot@0.2.45/types-create/types/lookup.ts' {
  interface ILookup {
