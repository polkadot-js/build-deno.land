...
import type { Enum, Option } from 'https://deno.land/x/polkadot@0.0.0-5/types-codec/mod.ts';
import type { ITuple } from 'https://deno.land/x/polkadot@0.0.0-5/types-codec/types.ts';
import type { AccountId, BlockNumber, Hash } from 'https://deno.land/x/polkadot@0.0.0-5/types/interfaces/runtime.ts';
