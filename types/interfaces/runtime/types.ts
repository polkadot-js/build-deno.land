...
import type { GenericAccountId32, GenericAccountId33, GenericAccountIndex, GenericBlock, GenericCall, GenericConsensusEngineId, GenericEthereumAccountId, GenericLookupSource, GenericMultiAddress, StorageKey } from 'https://deno.land/x/polkadot@0.2.28/types/mod.ts';
import type { Bytes, Compact, DoNotConstruct, Enum, Int, Null, Option, Struct, U8aFixed, UInt, Vec, u16, u32, u64, u8 } from 'https://deno.land/x/polkadot@0.2.28/types-codec/mod.ts';
...
import type { Signature } from 'https://deno.land/x/polkadot@0.2.28/types/interfaces/extrinsics/index.ts';
import type { Event, SystemOrigin } from 'https://deno.land/x/polkadot@0.2.28/types/interfaces/system/index.ts';
