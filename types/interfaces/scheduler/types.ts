...
import type { Bytes, Option, Struct, u32, u8 } from 'https://deno.land/x/polkadot@0.0.0-5/types-codec/mod.ts';
import type { ITuple } from 'https://deno.land/x/polkadot@0.0.0-5/types-codec/types.ts';
import type { BlockNumber, Call, PalletsOrigin } from 'https://deno.land/x/polkadot@0.0.0-5/types/interfaces/runtime.ts';
