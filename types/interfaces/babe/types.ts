...
import type { Enum, Option, Struct, U8aFixed, Vec, u32, u64 } from 'https://deno.land/x/polkadot@0.0.0-7/types-codec/mod.ts';
...
import type { Hash, Header } from 'https://deno.land/x/polkadot@0.0.0-7/types/interfaces/runtime.ts';
