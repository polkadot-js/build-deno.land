...
import type { Enum, Struct } from 'https://deno.land/x/polkadot@0.0.0-6/types-codec/mod.ts';
import type { AccountId, BlockNumber, Hash } from 'https://deno.land/x/polkadot@0.0.0-6/types/interfaces/runtime.ts';
