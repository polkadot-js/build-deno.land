...
import type { Enum, Struct } from 'https://deno.land/x/polkadot@0.2.25/types-codec/mod.ts';
import type { AccountId, BlockNumber, Hash } from 'https://deno.land/x/polkadot@0.2.25/types/interfaces/runtime/index.ts';
