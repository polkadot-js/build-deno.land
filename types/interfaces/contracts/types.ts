...
import type { Bytes, Compact, Enum, Null, Option, Raw, Result, Set, Struct, Text, U8aFixed, bool, u32, u64, u8 } from 'https://deno.land/x/polkadot@0.2.45/types-codec/mod.ts';
import type { AccountId, Balance, BlockNumber, Hash, Weight, WeightV2 } from 'https://deno.land/x/polkadot@0.2.45/types/interfaces/runtime/index.ts';
import type { DispatchError } from 'https://deno.land/x/polkadot@0.2.45/types/interfaces/system/index.ts';
