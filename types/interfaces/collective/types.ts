...
import type { Enum, Struct, Vec, u32 } from 'https://deno.land/x/polkadot@0.2.10/types-codec/mod.ts';
import type { ITuple } from 'https://deno.land/x/polkadot@0.2.10/types-codec/types/index.ts';
import type { AccountId, BlockNumber } from 'https://deno.land/x/polkadot@0.2.10/types/interfaces/runtime/index.ts';
