...
import type { Bytes, Enum, Struct, Text, U256, Vec, u256 } from 'https://deno.land/x/polkadot@0.0.7/types-codec/mod.ts';
import type { H160, H256 } from 'https://deno.land/x/polkadot@0.0.7/types/interfaces/runtime/index.ts';
