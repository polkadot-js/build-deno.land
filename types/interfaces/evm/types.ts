...
import type { Bytes, Enum, Option, Struct, Text, U256, Vec, u256, u64 } from 'https://deno.land/x/polkadot@0.2.43/types-codec/mod.ts';
import type { H160, H256 } from 'https://deno.land/x/polkadot@0.2.43/types/interfaces/runtime/index.ts';
