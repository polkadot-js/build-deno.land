...
import type { Bytes, Enum, Struct, Text, U256, Vec, u256 } from 'https://deno.land/x/polkadot@0.2.38/types-codec/mod.ts';
import type { H160, H256 } from 'https://deno.land/x/polkadot@0.2.38/types/interfaces/runtime/index.ts';
