...
import type { Bytes, Enum, Struct, Vec, u64 } from 'https://deno.land/x/polkadot@0.2.15/types-codec/mod.ts';
import type { BlockHash } from 'https://deno.land/x/polkadot@0.2.15/types/interfaces/chain/index.ts';
import type { Hash } from 'https://deno.land/x/polkadot@0.2.15/types/interfaces/runtime/index.ts';
