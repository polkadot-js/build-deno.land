...
import type { Bytes, Struct, U8aFixed, Vec, u32 } from 'https://deno.land/x/polkadot@0.0.0-8/types-codec/mod.ts';
import type { ITuple } from 'https://deno.land/x/polkadot@0.0.0-8/types-codec/types.ts';
import type { AccountId, ValidatorId } from 'https://deno.land/x/polkadot@0.0.0-8/types/interfaces/runtime.ts';
import type { Exposure } from 'https://deno.land/x/polkadot@0.0.0-8/types/interfaces/staking.ts';
