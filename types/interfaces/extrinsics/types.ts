...
import type { Enum, U8aFixed } from 'https://deno.land/x/polkadot@0.2.37/types-codec/mod.ts';
import type { H512 } from 'https://deno.land/x/polkadot@0.2.37/types/interfaces/runtime/index.ts';
