...
import type { Struct, bool, u8 } from 'https://deno.land/x/polkadot@0.2.41/types-codec/mod.ts';
import type { ITuple } from 'https://deno.land/x/polkadot@0.2.41/types-codec/types/index.ts';
import type { Balance, BlockNumber } from 'https://deno.land/x/polkadot@0.2.41/types/interfaces/runtime/index.ts';
