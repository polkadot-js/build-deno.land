...
import type { Bytes, Compact, Enum, Null, Option, Result, Struct, U8aFixed, Vec, bool, u128, u16, u32, u64, u8 } from 'https://deno.land/x/polkadot@0.2.26/types-codec/mod.ts';
import type { ITuple } from 'https://deno.land/x/polkadot@0.2.26/types-codec/types/index.ts';
import type { AccountId, BlockNumber, Weight } from 'https://deno.land/x/polkadot@0.2.26/types/interfaces/runtime/index.ts';
