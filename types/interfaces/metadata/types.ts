...
import type { PortableRegistry } from 'https://deno.land/x/polkadot@0.2.22/types/mod.ts';
import type { Bytes, Enum, Option, Struct, Text, Type, Vec, WrapperOpaque, bool, u8 } from 'https://deno.land/x/polkadot@0.2.22/types-codec/mod.ts';
import type { Si1Field, Si1LookupTypeId, Si1Type, SiLookupTypeId } from 'https://deno.land/x/polkadot@0.2.22/types/interfaces/scaleInfo/index.ts';
