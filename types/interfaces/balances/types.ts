...
import type { Enum, Set, Struct, U8aFixed } from 'https://deno.land/x/polkadot@0.0.0-8/types-codec/mod.ts';
import type { Balance, BlockNumber, LockIdentifier } from 'https://deno.land/x/polkadot@0.0.0-8/types/interfaces/runtime.ts';
