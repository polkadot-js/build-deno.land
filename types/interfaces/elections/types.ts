...
import type { GenericVote } from 'https://deno.land/x/polkadot@0.0.0-7/types/mod.ts';
import type { Compact, Enum, Struct, u32 } from 'https://deno.land/x/polkadot@0.0.0-7/types-codec/mod.ts';
import type { AccountId, Balance } from 'https://deno.land/x/polkadot@0.0.0-7/types/interfaces/runtime.ts';
