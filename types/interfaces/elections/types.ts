...
import type { GenericVote } from 'https://deno.land/x/polkadot@0.0.6/types/mod.ts';
import type { Compact, Enum, Struct, u32 } from 'https://deno.land/x/polkadot@0.0.6/types-codec/mod.ts';
import type { AccountId, Balance } from 'https://deno.land/x/polkadot@0.0.6/types/interfaces/runtime/index.ts';
