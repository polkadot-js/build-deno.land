...
import type { GenericVote } from 'https://deno.land/x/polkadot@0.0.0-5/types/mod.ts';
import type { Compact, Enum, Struct, u32 } from 'https://deno.land/x/polkadot@0.0.0-5/types-codec/mod.ts';
import type { AccountId, Balance } from 'https://deno.land/x/polkadot@0.0.0-5/types/interfaces/runtime.ts';
