...
import type { Option, Struct } from 'https://deno.land/x/polkadot@0.2.31/types-codec/mod.ts';
import type { Balance, Weight, WeightV1, WeightV2 } from 'https://deno.land/x/polkadot@0.2.31/types/interfaces/runtime/index.ts';
import type { DispatchClass } from 'https://deno.land/x/polkadot@0.2.31/types/interfaces/system/index.ts';
