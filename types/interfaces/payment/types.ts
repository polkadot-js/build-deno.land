...
import type { Balance, Weight } from 'https://deno.land/x/polkadot/types/interfaces/runtime.ts';
import type { DispatchClass } from 'https://deno.land/x/polkadot/types/interfaces/system.ts';
