...
import type { Option, Struct } from 'https://deno.land/x/polkadot@0.0.0-6/types-codec/mod.ts';
import type { Balance, Weight } from 'https://deno.land/x/polkadot@0.0.0-6/types/interfaces/runtime.ts';
import type { DispatchClass } from 'https://deno.land/x/polkadot@0.0.0-6/types/interfaces/system.ts';
