...
import type { Bytes, Enum, Struct } from 'https://deno.land/x/polkadot@0.2.19/types-codec/mod.ts';
import type { Balance, Permill } from 'https://deno.land/x/polkadot@0.2.19/types/interfaces/runtime/index.ts';
