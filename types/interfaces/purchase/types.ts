...
import type { Bytes, Enum, Struct } from 'https://deno.land/x/polkadot@0.0.1/types-codec/mod.ts';
import type { Balance, Permill } from 'https://deno.land/x/polkadot@0.0.1/types/interfaces/runtime/index.ts';
