...
import type { Bytes, Enum, Struct } from 'https://deno.land/x/polkadot@0.0.4-2/types-codec/mod.ts';
import type { Balance, Permill } from 'https://deno.land/x/polkadot@0.0.4-2/types/interfaces/runtime/index.ts';
