...
import type { Struct, Vec } from 'https://deno.land/x/polkadot@0.2.32/types-codec/mod.ts';
import type { CandidateReceipt, ParaId } from 'https://deno.land/x/polkadot@0.2.32/types/interfaces/parachains/index.ts';
import type { AccountId, BlockNumber, H256, Hash } from 'https://deno.land/x/polkadot@0.2.32/types/interfaces/runtime/index.ts';
