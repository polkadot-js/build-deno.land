...
import type { Struct, Vec } from 'https://deno.land/x/polkadot@0.0.0-7/types-codec/mod.ts';
import type { CandidateReceipt, ParaId } from 'https://deno.land/x/polkadot@0.0.0-7/types/interfaces/parachains.ts';
import type { AccountId, BlockNumber, H256, Hash } from 'https://deno.land/x/polkadot@0.0.0-7/types/interfaces/runtime.ts';
import type { SessionIndex } from 'https://deno.land/x/polkadot@0.0.0-7/types/interfaces/session.ts';
