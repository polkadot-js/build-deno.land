...
import type { Bytes, Enum, Text, Vec } from 'https://deno.land/x/polkadot@0.0.1/types-codec/mod.ts';
import type { Hash } from 'https://deno.land/x/polkadot@0.0.1/types/interfaces/runtime/index.ts';
