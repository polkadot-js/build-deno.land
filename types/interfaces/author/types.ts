...
import type { Bytes, Enum, Text, Vec } from 'https://deno.land/x/polkadot@0.0.0-8/types-codec/mod.ts';
import type { Hash } from 'https://deno.land/x/polkadot@0.0.0-8/types/interfaces/runtime.ts';
