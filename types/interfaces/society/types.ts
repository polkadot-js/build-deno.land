...
import type { Enum, Struct, u32 } from 'https://deno.land/x/polkadot@0.2.24/types-codec/mod.ts';
import type { ITuple } from 'https://deno.land/x/polkadot@0.2.24/types-codec/types/index.ts';
import type { AccountId, Balance } from 'https://deno.land/x/polkadot@0.2.24/types/interfaces/runtime/index.ts';
