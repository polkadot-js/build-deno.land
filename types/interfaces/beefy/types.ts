...
import type { Bytes, Option, Struct, U8aFixed, Vec, u32, u64 } from 'https://deno.land/x/polkadot@0.2.34/types-codec/mod.ts';
...
import type { EcdsaSignature, Signature } from 'https://deno.land/x/polkadot@0.2.34/types/interfaces/extrinsics/index.ts';
import type { BlockNumber, H256 } from 'https://deno.land/x/polkadot@0.2.34/types/interfaces/runtime/index.ts';
