...
import type { LeasePeriod } from 'https://deno.land/x/polkadot/types/interfaces/parachains.ts';
import type { AccountId, Balance, BlockNumber, MultiSigner } from 'https://deno.land/x/polkadot/types/interfaces/runtime.ts';
