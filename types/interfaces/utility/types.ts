...
import type { Struct, Vec, u32 } from 'https://deno.land/x/polkadot@0.2.31/types-codec/mod.ts';
import type { AccountId, Balance, BlockNumber } from 'https://deno.land/x/polkadot@0.2.31/types/interfaces/runtime/index.ts';
