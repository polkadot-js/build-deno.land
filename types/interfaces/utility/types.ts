...
import type { Struct, Vec, u32 } from 'https://deno.land/x/polkadot@0.0.0-6/types-codec/mod.ts';
import type { AccountId, Balance, BlockNumber } from 'https://deno.land/x/polkadot@0.0.0-6/types/interfaces/runtime.ts';
