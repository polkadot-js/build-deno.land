...
import type { Bytes, Struct, U8aFixed, Vec } from 'https://deno.land/x/polkadot@0.0.0-7/types-codec/mod.ts';
import type { ITuple } from 'https://deno.land/x/polkadot@0.0.0-7/types-codec/types.ts';
import type { AccountId, Hash, Perbill } from 'https://deno.land/x/polkadot@0.0.0-7/types/interfaces/runtime.ts';
import type { IdentificationTuple, SessionIndex } from 'https://deno.land/x/polkadot@0.0.0-7/types/interfaces/session.ts';
