...
import type { BTreeMap, Compact, Enum, Option, Struct, Vec, bool, u128, u16, u32, u64 } from 'https://deno.land/x/polkadot@0.2.40/types-codec/mod.ts';
import type { ITuple } from 'https://deno.land/x/polkadot@0.2.40/types-codec/types/index.ts';
import type { AccountId, Balance, BlockNumber, Moment, PerU16, Perbill } from 'https://deno.land/x/polkadot@0.2.40/types/interfaces/runtime/index.ts';
