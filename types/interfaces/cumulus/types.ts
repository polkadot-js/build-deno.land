...
import type { Struct, U8aFixed, u32, u64 } from 'https://deno.land/x/polkadot@0.0.1/types-codec/mod.ts';
import type { Weight } from 'https://deno.land/x/polkadot@0.0.1/types/interfaces/runtime/index.ts';
