...
import type { Option, Struct, U8aFixed, Vec, u32, u64 } from 'https://deno.land/x/polkadot@0.0.4-6/types-codec/mod.ts';
import type { HeadData, OutboundHrmpMessage, RelayBlockNumber, UpwardMessage, ValidationCode } from 'https://deno.land/x/polkadot@0.0.4-6/types/interfaces/parachains/index.ts';
import type { Weight } from 'https://deno.land/x/polkadot@0.0.4-6/types/interfaces/runtime/index.ts';
