...
import type { AnyJson, AnyTuple, Registry } from 'https://deno.land/x/polkadot@0.0.0-5/types-codec/types.ts';
import type { Call, FunctionMetadataLatest } from '../../../interfaces/index.ts';
import type { CallFunction, IMethod } from '../../../types/index.ts';

import { stringCamelCase } from 'https://deno.land/x/polkadot@0.0.0-5/util/mod.ts';
