...
import type { AnyTuple, Registry } from 'https://deno.land/x/polkadot@0.0.0-6/types-codec/types.ts';
...
import { isCodec, isU8a, lazyMethod, stringCamelCase } from 'https://deno.land/x/polkadot@0.0.0-6/util/mod.ts';
