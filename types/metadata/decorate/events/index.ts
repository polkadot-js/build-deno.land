...
import type { AnyTuple, Registry } from 'https://deno.land/x/polkadot@0.2.18/types-codec/types/index.ts';
...
import { isCodec, isU8a, lazyMethod, stringCamelCase } from 'https://deno.land/x/polkadot@0.2.18/util/mod.ts';
