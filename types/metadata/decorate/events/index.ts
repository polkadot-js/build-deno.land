...
import type { AnyTuple, Registry } from 'https://deno.land/x/polkadot@0.0.4-4/types-codec/types/index.ts';
...
import { isCodec, isU8a, lazyMethod, stringCamelCase } from 'https://deno.land/x/polkadot@0.0.4-4/util/mod.ts';
