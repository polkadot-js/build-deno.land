...
import type { AnyTuple, Registry } from 'https://deno.land/x/polkadot@0.0.0-7/types-codec/types.ts';
...
import { isCodec, isU8a, lazyMethod, stringCamelCase } from 'https://deno.land/x/polkadot@0.0.0-7/util/mod.ts';
