...
import type { AnyJson, Codec, CodecClass } from 'https://deno.land/x/polkadot@0.1.0/types-codec/types/index.ts';
...
import { Null, Struct, Tuple } from 'https://deno.land/x/polkadot@0.1.0/types-codec/mod.ts';
import { objectProperties, objectSpread } from 'https://deno.land/x/polkadot@0.1.0/util/mod.ts';
