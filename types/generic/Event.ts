...
import type { AnyJson, Codec, CodecClass } from 'https://deno.land/x/polkadot@0.0.0-5/types-codec/types.ts';
...
import { Null, Struct, Tuple } from 'https://deno.land/x/polkadot@0.0.0-5/types-codec/mod.ts';
import { objectProperties, objectSpread } from 'https://deno.land/x/polkadot@0.0.0-5/util/mod.ts';
