...
import { Json, Option, Text, u32, Vec } from 'https://deno.land/x/polkadot@0.0.4-2/types-codec/mod.ts';
import { isFunction, isNull, isUndefined } from 'https://deno.land/x/polkadot@0.0.4-2/util/mod.ts';
