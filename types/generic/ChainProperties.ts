...
import type { Option, Text, u32, Vec } from 'https://deno.land/x/polkadot@0.2.40/types-codec/mod.ts';
...
import { Json } from 'https://deno.land/x/polkadot@0.2.40/types-codec/mod.ts';
import { isFunction, isNull, isUndefined } from 'https://deno.land/x/polkadot@0.2.40/util/mod.ts';
