...
import { Enum } from 'https://deno.land/x/polkadot@0.2.34/types-codec/mod.ts';
import { isBn, isNumber, isString, isU8a } from 'https://deno.land/x/polkadot@0.2.34/util/mod.ts';
