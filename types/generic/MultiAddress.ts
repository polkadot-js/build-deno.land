...
import { Enum } from 'https://deno.land/x/polkadot@0.2.18/types-codec/mod.ts';
import { isBn, isNumber, isString, isU8a } from 'https://deno.land/x/polkadot@0.2.18/util/mod.ts';
