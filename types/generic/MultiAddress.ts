...
import { Enum } from 'https://deno.land/x/polkadot@0.0.1/types-codec/mod.ts';
import { isBn, isNumber, isString, isU8a } from 'https://deno.land/x/polkadot@0.0.1/util/mod.ts';
