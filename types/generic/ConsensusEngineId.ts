...
import type { Bytes, u32 } from 'https://deno.land/x/polkadot@0.2.40/types-codec/mod.ts';
import type { AnyU8a, Registry } from 'https://deno.land/x/polkadot@0.2.40/types-codec/types/index.ts';
...
import { BN, bnToU8a, isNumber, stringToU8a, u8aToHex, u8aToString } from 'https://deno.land/x/polkadot@0.2.40/util/mod.ts';
