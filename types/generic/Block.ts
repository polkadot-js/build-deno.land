...
import type { AnyNumber, AnyU8a, IU8a, Registry } from 'https://deno.land/x/polkadot@0.2.1/types-codec/types/index.ts';
...
import { Struct } from 'https://deno.land/x/polkadot@0.2.1/types-codec/mod.ts';
