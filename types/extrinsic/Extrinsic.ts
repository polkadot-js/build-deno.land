...
import type { GeneralExtrinsic } from '../index.types.ts';
import type { EcdsaSignature, Ed25519Signature, ExtrinsicSignatureV5, ExtrinsicUnknown, ExtrinsicV5, Sr25519Signature } from '../interfaces/extrinsics/index.ts';
...
import type { Preamble } from './types.ts';
import type { ExtrinsicValueV5 } from './v5/Extrinsic.ts';
