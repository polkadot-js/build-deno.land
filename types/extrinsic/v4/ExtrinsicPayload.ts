...
import type { Inspect, Registry } from 'https://deno.land/x/polkadot@0.2.14/types-codec/types/index.ts';
...
import { Bytes, Enum, Struct } from 'https://deno.land/x/polkadot@0.2.14/types-codec/mod.ts';
