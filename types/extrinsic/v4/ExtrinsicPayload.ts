...
import type { Inspect, Registry } from 'https://deno.land/x/polkadot/types-codec/types.ts';
...
import { Bytes, Enum, Struct } from 'https://deno.land/x/polkadot/types-codec/mod.ts';
