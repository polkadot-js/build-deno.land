...
import type { SignOptions } from 'https://deno.land/x/polkadot@0.0.4-5/keyring/types.ts';
...
import { Bytes, Enum, Struct } from 'https://deno.land/x/polkadot@0.0.4-5/types-codec/mod.ts';
