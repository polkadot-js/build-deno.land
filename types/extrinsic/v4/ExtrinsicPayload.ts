...
import type { SignOptions } from 'https://deno.land/x/polkadot@0.0.4-3/keyring/types.ts';
...
import { Bytes, Enum, Struct } from 'https://deno.land/x/polkadot@0.0.4-3/types-codec/mod.ts';
import { objectSpread } from 'https://deno.land/x/polkadot@0.0.4-3/util/mod.ts';
