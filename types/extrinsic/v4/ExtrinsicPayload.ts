...
import type { Inspect, Registry } from 'https://deno.land/x/polkadot@0.2.39/types-codec/types/index.ts';
...
import { Enum, Struct } from 'https://deno.land/x/polkadot@0.2.39/types-codec/mod.ts';
