...
import type { Bytes } from 'https://deno.land/x/polkadot@0.2.45/types-codec/mod.ts';
import type { Inspect, Registry } from 'https://deno.land/x/polkadot@0.2.45/types-codec/types/index.ts';
...
import { Enum, Struct } from 'https://deno.land/x/polkadot@0.2.45/types-codec/mod.ts';
