...
import type { SignOptions } from 'https://deno.land/x/polkadot@0.0.0-5/keyring/types.ts';
...
import { Bytes, Enum, Struct } from 'https://deno.land/x/polkadot@0.0.0-5/types-codec/mod.ts';
import { objectSpread } from 'https://deno.land/x/polkadot@0.0.0-5/util/mod.ts';
