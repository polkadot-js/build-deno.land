...
import type { SignOptions } from 'https://deno.land/x/polkadot@0.0.4-6/keyring/types.ts';
...
import { Bytes, Enum, Struct } from 'https://deno.land/x/polkadot@0.0.4-6/types-codec/mod.ts';
import { objectSpread } from 'https://deno.land/x/polkadot@0.0.4-6/util/mod.ts';
