...
import type { AnyJson, BareOpts, Registry } from 'https://deno.land/x/polkadot@0.2.39/types-codec/types/index.ts';
...
import { u8aToHex } from 'https://deno.land/x/polkadot@0.2.39/util/mod.ts';
