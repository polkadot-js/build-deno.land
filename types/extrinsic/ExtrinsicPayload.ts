...
import type { AnyJson, BareOpts, Registry } from 'https://deno.land/x/polkadot@0.2.26/types-codec/types/index.ts';
...
import { AbstractBase, Bytes } from 'https://deno.land/x/polkadot@0.2.26/types-codec/mod.ts';
