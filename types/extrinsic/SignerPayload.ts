...
import type { Text, Vec } from 'https://deno.land/x/polkadot@0.2.37/types-codec/mod.ts';
...
import { Option, Struct } from 'https://deno.land/x/polkadot@0.2.37/types-codec/mod.ts';
import { objectProperty, objectSpread, u8aToHex } from 'https://deno.land/x/polkadot@0.2.37/util/mod.ts';
