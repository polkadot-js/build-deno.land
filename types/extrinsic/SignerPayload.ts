...
import { Option, Struct, Text, Vec } from 'https://deno.land/x/polkadot@0.0.5/types-codec/mod.ts';
import { objectProperty, objectSpread, u8aToHex } from 'https://deno.land/x/polkadot@0.0.5/util/mod.ts';
