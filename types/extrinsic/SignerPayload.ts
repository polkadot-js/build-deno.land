...
import type { Text, Vec } from 'https://deno.land/x/polkadot@0.2.45/types-codec/mod.ts';
import type { AnyJson, Registry } from 'https://deno.land/x/polkadot@0.2.45/types-codec/types/index.ts';
...
import { Option, Struct } from 'https://deno.land/x/polkadot@0.2.45/types-codec/mod.ts';
import { objectProperty, objectSpread, u8aToHex } from 'https://deno.land/x/polkadot@0.2.45/util/mod.ts';
