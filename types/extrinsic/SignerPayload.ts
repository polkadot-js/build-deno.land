...
import { Option, Struct, Text, Vec } from 'https://deno.land/x/polkadot@0.2.32/types-codec/mod.ts';
import { objectProperty, objectSpread, u8aToHex } from 'https://deno.land/x/polkadot@0.2.32/util/mod.ts';
