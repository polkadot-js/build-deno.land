...
import { Option, Struct, Text, Vec } from 'https://deno.land/x/polkadot@0.2.17/types-codec/mod.ts';
import { objectProperty, objectSpread, u8aToHex } from 'https://deno.land/x/polkadot@0.2.17/util/mod.ts';
