...
import type { AnyString, AnyU8a, Registry } from 'https://deno.land/x/polkadot@0.2.45/types-codec/types/index.ts';
...
import { ethereumEncode, isEthereumAddress } from 'https://deno.land/x/polkadot@0.2.45/util-crypto/mod.ts';
