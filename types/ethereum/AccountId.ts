...
import type { AnyString, AnyU8a, Registry } from 'https://deno.land/x/polkadot@0.2.18/types-codec/types/index.ts';
...
import { ethereumEncode, isEthereumAddress } from 'https://deno.land/x/polkadot@0.2.18/util-crypto/mod.ts';
