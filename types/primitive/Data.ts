...
import type { IU8a, Registry } from 'https://deno.land/x/polkadot@0.0.4/types-codec/types/index.ts';
import type { H256 } from '../interfaces/runtime/index.ts';

import { Bytes, Enum } from 'https://deno.land/x/polkadot@0.0.4/types-codec/mod.ts';
