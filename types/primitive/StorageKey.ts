...
import type { AnyJson, AnyTuple, Codec } from 'https://deno.land/x/polkadot@0.2.26/types-codec/types/index.ts';
...
import { Bytes } from 'https://deno.land/x/polkadot@0.2.26/types-codec/mod.ts';
import { isFunction, isString, isU8a } from 'https://deno.land/x/polkadot@0.2.26/util/mod.ts';
