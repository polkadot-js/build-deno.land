...
import type { Header } from 'https://deno.land/x/polkadot/types/interfaces.ts';
...
import rpcHeader from 'https://deno.land/x/polkadot/types-support/json/Header.004.json.ts';
import rpcSignedBlock from 'https://deno.land/x/polkadot/types-support/json/SignedBlock.004.immortal.json.ts';
