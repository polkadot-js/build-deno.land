...
import type { Constructor } from 'https://deno.land/x/polkadot@0.2.40/util/types.ts';
...
import { isChildClass, isNull, isUndefined, logger, objectSpread } from 'https://deno.land/x/polkadot@0.2.40/util/mod.ts';
