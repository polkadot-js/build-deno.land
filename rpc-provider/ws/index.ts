...
import type { Constructor } from 'https://deno.land/x/polkadot@0.2.39/util/types.ts';
...
import { isChildClass, isNull, isUndefined, logger, objectSpread } from 'https://deno.land/x/polkadot@0.2.39/util/mod.ts';
import { xglobal } from 'https://deno.land/x/polkadot@0.2.39/x-global/mod.ts';
