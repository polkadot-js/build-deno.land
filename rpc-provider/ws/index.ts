...
import type { Class } from 'https://deno.land/x/polkadot@0.2.44/util/types.ts';
...
import { isChildClass, isNull, isUndefined, logger, noop, objectSpread } from 'https://deno.land/x/polkadot@0.2.44/util/mod.ts';
