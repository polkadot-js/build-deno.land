...
```javascript
import { HttpProvider } from 'https://deno.land/x/polkadot@0.2.24/rpc-provider/mod.ts';
...
```javascript
import { ScProvider } from 'https://deno.land/x/polkadot@0.2.24/rpc-provider/mod.ts';
