...
```javascript
import { HttpProvider } from 'https://deno.land/x/polkadot@0.0.3/rpc-provider/mod.ts';
...
```javascript
import { ScProvider, WellKnownChain } from 'https://deno.land/x/polkadot@0.0.3/rpc-provider/substrate-connect/index.ts';
