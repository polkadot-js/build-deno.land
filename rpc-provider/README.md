...
```javascript
import { HttpProvider } from 'https://deno.land/x/polkadot@0.2.39/rpc-provider/mod.ts';
...
```javascript
import { ScProvider } from 'https://deno.land/x/polkadot@0.2.39/rpc-provider/mod.ts';
import * as Sc from 'https://esm.sh/@substrate/connect@0.7.26';
