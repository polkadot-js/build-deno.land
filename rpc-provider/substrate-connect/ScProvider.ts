...
import type { Config as ScConfig } from 'https://cdn.skypack.dev/@substrate/connect@0.7.7';
...
import { Chain, createScClient, ScClient, WellKnownChain } from 'https://cdn.skypack.dev/@substrate/connect@0.7.7';
