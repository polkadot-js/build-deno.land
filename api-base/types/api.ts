...
import type { DecoratedRpc, QueryableConsts, QueryableStorage, QueryableStorageMulti, SubmittableExtrinsics } from 'https://deno.land/x/polkadot@0.0.5/api-base/types/index.ts';
...
import type { Registry, Signer } from 'https://deno.land/x/polkadot@0.0.5/types/types/index.ts';
