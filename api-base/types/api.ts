...
import type { DecoratedRpc, QueryableCalls, QueryableConsts, QueryableStorage, QueryableStorageMulti, SubmittableExtrinsics } from 'https://deno.land/x/polkadot@0.2.38/api-base/types/index.ts';
...
import type { Registry, Signer } from 'https://deno.land/x/polkadot@0.2.38/types/types/index.ts';
