...
import type { PalletConstantMetadataLatest } from 'https://deno.land/x/polkadot@0.0.8/types/interfaces/index.ts';
import type { Codec } from 'https://deno.land/x/polkadot@0.0.8/types/types/index.ts';
