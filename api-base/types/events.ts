...
import type { IsEvent } from 'https://deno.land/x/polkadot@0.2.37/types/metadata/decorate/types.ts';
import type { AnyTuple } from 'https://deno.land/x/polkadot@0.2.37/types/types/index.ts';
