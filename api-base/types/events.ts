...
import type { IsEvent } from 'https://deno.land/x/polkadot@0.2.18/types/metadata/decorate/types.ts';
import type { AnyTuple } from 'https://deno.land/x/polkadot@0.2.18/types/types/index.ts';
